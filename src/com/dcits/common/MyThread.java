...
import com.dcits.supervise.pecr.generateReport.impl.GenerateBsSgmtRp;
...
public class MyThread implements SmartLifecycle{
	...
	public void init(){
        ...
        corePoolSize = parseInt(getProperty("corePoolSize","500"),500);//100
        //corePoolSize = parseInt(getProperty("corePoolSize","50"),50);
        maxPoolSize = parseInt(getProperty("maxPoolSize","100"),100);
	 ...
	 * @return
	 */
	public boolean generateThread(String name,ReportFeedBackMessageService reportFeedBackMessageService)  {
		 logger.info("创建线程处理客户端任务");
		//executor.execute(new MyThreadTo(name,reportFeedBackMessageService,properties));
		return true;
	}
	...
	public void checkNotNull(Object object){
        if(object==null){
            throw new RuntimeException(object.getClass().getName()+"未初始化");
        }
    }
