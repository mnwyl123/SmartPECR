 ...
 *
 */
public class EntBalanceSheetBsSgmt implements Serializable {
	
	private static final long serialVersionUID = -6022728110659503300L;
	
	/**
	 * 主键
	 */
	private String ehaBalanceSheetBsSgmtId;
	...
	public String getEhaBalanceSheetBsSgmtId() {
		return ehaBalanceSheetBsSgmtId;
	}

	public void setEhaBalanceSheetBsSgmtId(String ehaBalanceSheetBsSgmtId) {
		this.ehaBalanceSheetBsSgmtId = ehaBalanceSheetBsSgmtId;
	}
