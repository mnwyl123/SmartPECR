...
public class EntIncomeStatement implements Serializable {
	...
	private static final long serialVersionUID = -4069876162958723914L;

	/**
	 * 主键
	 */
	private String eiaIncomeStatementProfitId;
	...
	public String getEiaIncomeStatementProfitId() {
		return eiaIncomeStatementProfitId;
	}

	public void setEiaIncomeStatementProfitId(String eiaIncomeStatementProfitId) {
		this.eiaIncomeStatementProfitId = eiaIncomeStatementProfitId;
	}
