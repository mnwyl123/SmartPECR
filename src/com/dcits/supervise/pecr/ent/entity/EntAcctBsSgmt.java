 ...
 *
 */
public class EntAcctBsSgmt implements Serializable {
	
	private static final long serialVersionUID = -5440523909618504450L;
	/**
	 * 主键
	 */
	private String edaAcctBsSgmtId ;
	/**
	 * 信息记录类型
	 */
	...
	public String getEdaAcctBsSgmtId() {
		return edaAcctBsSgmtId;
	}
	public void setEdaAcctBsSgmtId(String edaAcctBsSgmtId) {
		this.edaAcctBsSgmtId = edaAcctBsSgmtId;
	}
