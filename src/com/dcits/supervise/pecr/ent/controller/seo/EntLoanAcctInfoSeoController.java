 ...
 */
@Controller
@RequestMapping("/entLoanAcctInfoSeo")
public class EntLoanAcctInfoSeoController extends BaseController{
	@Autowired
	private EntLoanAcctInfoSeoManager indvSeoService;
	...
	public String dataPage() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoSeoList";
	}
	@RequestMapping("/listPageForUpdate")
	public String dataPageForUpdate() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoUpdateSeoList";
	}
	/**
	 * 获取表格数据列表
	 * @param page
	...
	public ModelAndView listHistPage(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoSeoHist");
		return mv;
	}
	...
	public ModelAndView listHistPageForUpdate(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoUpdateSeoHist");
		return mv;
	}
	...
	public Map<String, Object> backdate(Page page){
		...
		try {
			...
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("COMPANY", company);
			map.put("baseId", pd.getString("edaAcctBsSgmtId"));
	...
	public ModelAndView dataDetail(Page page) {
		...
		try {
			...
			if(addOrUpdate != null && !"add".equals(addOrUpdate)){
				...
				//初始债权说明段
				PageData creditorInfSgmt = indvSeoService.getCreditorInfSgmtById(pd);
				//还款表现信息段
				PageData lbltyInfSgmt = indvSeoService.getLbltyInfSgmtById(pd);
		...
		if(queryType != null && "entLoanUpdateBySegment".equals(queryType)){
			mv.setViewName("pecr/ent/dataRecode/entLoanChangeEdit");
		}else{
			mv.setViewName("pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEdit");
		}
		return mv;
	}
	/**
	...
	public String indvLoanAcctInfoEditD1() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditD1";
	}
	...
	public String indvLoanAcctInfoEditR2() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditD2";
	}
	...
	public String indvLoanAcctInfoEditR1() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditR1";
	}
	...
	public String indvLoanAcctInfoEditR4() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditR4";
	}
	...
	public String indvLoanAcctInfoEditC1() {
		return "pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditC1";
	}
}
