 ...
 */
@Controller
@RequestMapping("/entBalanceInfoSeo")
public class EntBalanceSheetInfoSeoController extends BaseController{

	@Autowired
	private EntBalanceSheetInfoSeoManager entBalanceSheetInfoService;
	...
	public String dataPage() {
		return "pecr/ent/seo/entBalanceInfoSeo/entBalanceInfoSeoList";
	}
	...
	public Map<String, Object> dataList(Page page){
		...
		try {
			...
			page.setPd(pd);
			List<PageData> dataList = entBalanceSheetInfoService.dataList(page);
	...
	public ModelAndView listHistPage(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/ent/seo/entBalanceInfoSeo/entBalanceInfoSeoHist");
		return mv;
	}
	...
	public Map<String, Object> dataHistList(Page page){
		...
		try {
			...
			page.setShowCount(limit);
			page.setPd(pd);
			List<EntBalanceSheetBsSgmt> dataList = entBalanceSheetInfoService.dataHistList(page);
			resultMap.put("code", 0);
			resultMap.put("msg","");
			resultMap.put("count", page.getTotalResult());
			resultMap.put("data", dataList);
	...
	public Map<String, Object> updatedate(Page page){
		...
		try {
			...
			entBalanceSheetInfoService.updateStatus(map);
	...
	public Map<String, Object> backdate(Page page){
		...
		try {
			...
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("COMPANY", company);
			map.put("baseId", pd.getString("ehaBalanceSheetBsSgmtId"));
			map.put("reportMessageId", pd.getString("reportMessageId"));
			entBalanceSheetInfoService.backdate(map);
			entBalanceSheetInfoService.updateStatus(map);
			entBalanceSheetInfoService.deletedate(map);
			resultMap.put("success", true);
		}catch(Exception e) {
			logger.error(e.getMessage());
			resultMap.put("success", false);
