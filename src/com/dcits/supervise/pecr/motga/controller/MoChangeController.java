...
@Controller
@RequestMapping("/moChange")
public class MoChangeController extends BaseController {
	
	@Autowired
	private MoChangeManager motgaCltalBsInfoService;
	...
	public ModelAndView dataPage(Page page) {
		...
		mv.setViewName("pecr/mortgage/moChangeList");
		return mv;
	}
	 ...
	 * @return
	 */
	@Operate(modulName = "删除MotgaContractInfo")
	 ...
	 *     新增或修改数据
	 */
	@Operate(modulName = "新增/修改MotgaCltalInfo")
