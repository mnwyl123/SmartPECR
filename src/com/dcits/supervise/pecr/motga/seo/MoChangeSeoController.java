...
@Controller
@RequestMapping("/moChangeSeo")
public class MoChangeSeoController extends BaseController {
	
	@Autowired
	private MoChangeSeoManager motgaCltalBsInfoService;
	...
	public String dataPage() {
		return "pecr/mortgage/seo/mortgageChangeSeoList";
	}
	...
	public ModelAndView listHistPage(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/mortgage/seo/mortgageChangeSeoHist");
		return mv;
	}
	...
	public Map<String, Object> backdate(Page page){
		...
		try {
			PageData pd = this.getPageData();
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("baseId", pd.getString("efwMocId"));
