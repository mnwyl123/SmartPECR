...
@Service("MoDelSeoManager")
public class MoDelSeoService  implements  MoDelSeoManager{
    ...
    public List<PageData> dataList(Page page) throws Exception {
        return (List<PageData>) dao.findForList("MoDelSeoMapper.datalistPage", page);
    }
    /**
	 * 查询 当前表+历史表
	 * 
    ...
    public List<MotgaCltalCtrctBsSgmt> dataHistList(Page page) throws Exception {
        return (List<MotgaCltalCtrctBsSgmt>) dao.findForList("MoDelSeoMapper.dataHistlistPage", page);
    }
    /**
   	 * 更新状态到11
   	 * 
	...
	public void updateStatus(Map<String, Object> map) throws Exception {
		dao.update("MoDelSeoMapper.updateStatusSec", map);		
	}
	...
	public void backdate(Map<String, Object> map) throws Exception {
		dao.update("MoDelSeoMapper.backdate", map);		
	}
	...
	public void deletedate(Map<String, Object> map) throws Exception {
		dao.delete("MoDelSeoMapper.deletedate", map);
	}
