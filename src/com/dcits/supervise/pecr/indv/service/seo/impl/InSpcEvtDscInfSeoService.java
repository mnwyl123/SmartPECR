...
@Service
public class InSpcEvtDscInfSeoService implements InSpcEvtDscInfSeoManager{
    ...
    public List<PageData> dataList(Page page) throws Exception {
        return (List<PageData>) dao.findForList("InSpcEvtDscInfSeoMapper.datalistPage", page);
    }
    /**
	 * 查询 当前表+历史表
	 * 
    ...
    public List<PecrIndvBsSgmt> dataHistList(Page page) throws Exception {
        return (List<PecrIndvBsSgmt>) dao.findForList("InSpcEvtDscInfSeoMapper.dataHistlistPage", page);
    }
    /**
   	 * 更新状态到11
   	 * 
	...
	public void updateStatus(Map<String, Object> map) throws Exception {
		dao.update("InSpcEvtDscInfSeoMapper.updateStatus", map);		
	}
	/**
   	 * 更新状态到20
   	 * 
	...
	public void backdate(Map<String, Object> map) throws Exception {
		dao.update("InSpcEvtDscInfSeoMapper.backdate", map);		
	}
	/**
   	 * 删除报文数据信息
   	 * 
	...
	public void deletedate(Map<String, Object> map) throws Exception {
		dao.delete("InSpcEvtDscInfSeoMapper.deletedate", map);
	}
}
