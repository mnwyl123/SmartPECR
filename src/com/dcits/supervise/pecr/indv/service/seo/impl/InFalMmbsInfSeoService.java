...
@Service
public class InFalMmbsInfSeoService implements InFalMmbsInfSeoManager{
    ...
    public List<PageData> dataList(Page page) throws Exception {
        return (List<PageData>) dao.findForList("InFalMmbsInfSeoMapper.datalistPage", page);
    }
    /**
	 * 查询 当前表+历史表
	 * 
    ...
    public List<PecrIndvBsSgmt> dataHistList(Page page) throws Exception {
        return (List<PecrIndvBsSgmt>) dao.findForList("InFalMmbsInfSeoMapper.dataHistlistPage", page);
    }
	/**
   	 * 更新状态到11
   	 * 
	...
	public void updateStatus(Map<String, Object> map) throws Exception {
		dao.update("InFalMmbsInfSeoMapper.updateStatus", map);		
	}
	/**
   	 * 更新状态到20
   	 * 
	...
	public void backdate(Map<String, Object> map) throws Exception {
		dao.update("InFalMmbsInfSeoMapper.backdate", map);		
	}
	/**
   	 * 删除报文数据信息
   	 * 
	...
	public void deletedate(Map<String, Object> map) throws Exception {
		dao.delete("InFalMmbsInfSeoMapper.deletedate", map);
	}
}
