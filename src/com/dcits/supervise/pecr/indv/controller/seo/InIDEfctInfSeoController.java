 ...
 */
@Controller
@RequestMapping("/inIDEfctInfSeo")
public class InIDEfctInfSeoController extends BaseController{

	@Autowired
	private InIDEfctInfSeoManager indvSeoService;
	...
	public String dataPage() {
		return "pecr/indv/seo/inIDEfctInfSeo/inIDEfctInfSeoList";
	}
	...
	public ModelAndView listHistPage(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/indv/seo/inIDEfctInfSeo/inIDEfctInfSeoHist");
		return mv;
	}
	...
	public Map<String, Object> updatedate(Page page){
		...
		try {
			...
			map.put("baseId", pd.getString("pakInIdEfctInfId"));
