 ...
 */
@Controller
@RequestMapping("/inSpcEvtDscInfSeo")
public class InSpcEvtDscInfSeoController extends BaseController{
	@Autowired
	private InSpcEvtDscInfSeoManager indvSeoService;
	...
	public String dataPage() {
		return "pecr/indv/seo/inSpcEvtDscInfSeo/inSpcEvtDscInfSeoList";
	}
	...
	public ModelAndView listHistPage(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/indv/seo/inSpcEvtDscInfSeo/inSpcEvtDscInfSeoHist");
		return mv;
	}
	...
	public Map<String, Object> updatedate(Page page){
		...
		try {
			...
			map.put("baseId", pd.getString("pbkInSpcEvtDscInfId"));
