 ...
 */
@Controller
@RequestMapping("/inFalMmbsInfSeo")
public class InFalMmbsInfSeoContorller extends BaseController{

	@Autowired
	private InFalMmbsInfSeoManager indvSeoService;
	...
	public String dataPage() {
		return "pecr/indv/seo/inFalMmbsInfSeo/inFalMmbsInfSeoList";
	}
	...
	public ModelAndView listHistPage(Page page) { 
		...
		PageData pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("pecr/indv/seo/inFalMmbsInfSeo/inFalMmbsInfSeoHist");
		return mv;
	}
	...
	public Map<String, Object> updatedate(Page page){
		...
		try {
			...
			map.put("baseId", pd.getString("pajInFalMmbsInfId"));
