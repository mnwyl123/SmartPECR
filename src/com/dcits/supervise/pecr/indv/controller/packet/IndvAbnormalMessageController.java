...
@Controller
@RequestMapping("/indvAbnormalMessage")
public class IndvAbnormalMessageController extends BaseController{
	 ...
	 * @return
	 */
	@RequestMapping("/indvAbnormalMessagePage")
	public String dataPage() {
		return "pecr/indv/packet/indvAbnormalMessage";
	}
	...
	public Map<String, Object> dataList(Page page){
		...
		try {
			...
			page.setPd(pd);
			List<Map<String, Object>> dataList = indvNormalMessageService.getAbnormalMessage(page);
