...
public class FeedBackReportPartFail214 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail214.class);
	
	public FeedBackReportPartFail214(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InAcctEntDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_214);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_214);
