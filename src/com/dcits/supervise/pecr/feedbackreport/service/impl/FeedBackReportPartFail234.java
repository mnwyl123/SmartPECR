...
public class FeedBackReportPartFail234 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail234.class);
	
	public FeedBackReportPartFail234(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InSecAcctEntDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_234);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_234);
