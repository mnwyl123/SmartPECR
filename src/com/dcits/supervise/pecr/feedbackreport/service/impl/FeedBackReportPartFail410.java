...
public class FeedBackReportPartFail410 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail410.class);
	
	public FeedBackReportPartFail410(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("EnAcctInf");
		Element sgmt = bas.element("AcctBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_410);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_410);
