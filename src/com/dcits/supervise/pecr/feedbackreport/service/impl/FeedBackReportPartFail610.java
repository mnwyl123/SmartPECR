...
public class FeedBackReportPartFail610 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail610.class);
	
	public FeedBackReportPartFail610(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("BalanceSheet");
		Element sgmt = bas.element("BalanceSheetBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_610);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_610);
