...
public class FeedBackReportPartFail411 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail411.class);
	
	public FeedBackReportPartFail411(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnAcctInfIDCagsInf");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_411);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_411);
