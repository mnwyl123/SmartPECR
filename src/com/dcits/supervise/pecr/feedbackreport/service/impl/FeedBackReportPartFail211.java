...
public class FeedBackReportPartFail211 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail211.class);
	
	public FeedBackReportPartFail211(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InAcctIDCagsInf");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_211);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_211);
