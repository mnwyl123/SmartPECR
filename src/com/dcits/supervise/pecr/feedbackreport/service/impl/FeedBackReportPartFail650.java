...
public class FeedBackReportPartFail650 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail650.class);
	
	public FeedBackReportPartFail650(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("IncomeAndExpenseStatement");
		Element sgmt = bas.element("IncomeAndExpenseStatementBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_650);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_650);
