...
public class FeedBackReportPartFail310 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail310.class);
	
	public FeedBackReportPartFail310(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("EnBasInf");
		Element sgmt = bas.element("BsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_310);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_310);
