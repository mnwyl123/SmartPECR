...
public class FeedBackReportPartFail444 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail444.class);
	
	public FeedBackReportPartFail444(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnSecAcctDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_444);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_444);
