...
public class FeedBackReportPartFail223 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail223.class);
	
	public FeedBackReportPartFail223(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InCtrctDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_223);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_223);
