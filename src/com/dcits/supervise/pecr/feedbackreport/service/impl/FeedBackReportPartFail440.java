...
public class FeedBackReportPartFail440 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail440.class);
	
	public FeedBackReportPartFail440(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("EnSecAcctInf");
		Element sgmt = bas.element("GuarAcctBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_440);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_440);
