...
public class FeedBackReportPartFail314 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail314.class);
	
	public FeedBackReportPartFail314(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnBsInfDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_314);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_314);
