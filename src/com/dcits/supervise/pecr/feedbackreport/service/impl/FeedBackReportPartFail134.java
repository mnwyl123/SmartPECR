...
public class FeedBackReportPartFail134 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail134.class);
	
	public FeedBackReportPartFail134(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InIDEfctInfDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_134);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_134);
