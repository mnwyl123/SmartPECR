...
public class FeedBackReportPartFail441 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail441.class);
	
	public FeedBackReportPartFail441(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnSecAcctIDCagsInf");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_441);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_441);
