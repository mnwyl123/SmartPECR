...
public class FeedBackReportPartFail414 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail414.class);
	
	public FeedBackReportPartFail414(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnAcctInfEntDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_414);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_414);
