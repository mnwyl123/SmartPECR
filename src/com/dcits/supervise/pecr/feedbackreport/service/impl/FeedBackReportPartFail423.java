...
public class FeedBackReportPartFail423 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail423.class);
	
	public FeedBackReportPartFail423(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnCtrctInfDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_423);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_423);
