...
public class FeedBackReportPartFail140 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail140.class);
	
	public FeedBackReportPartFail140(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InCtfItgInf");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_140);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_140);
		...
		list.add(new ConditionColumAndValue("OTH_NAME",sgmt.element("OthName").getStringValue()));
		list.add(new ConditionColumAndValue("OTH_ID_TYPE",sgmt.element("OthIDType").getStringValue()));
		list.add(new ConditionColumAndValue("OTH_ID_NUM",sgmt.element("OthIDNum").getStringValue()));
