...
public class FeedBackReportPartFail620 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail620.class);
	
	public FeedBackReportPartFail620(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("IncomeStatementProfitAppropriation");
		Element sgmt = bas.element("IncomeStatementProfitAppropriationBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_620);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_620);
