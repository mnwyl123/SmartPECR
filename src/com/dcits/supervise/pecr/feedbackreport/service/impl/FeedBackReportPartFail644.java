...
public class FeedBackReportPartFail644 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail644.class);
	
	public FeedBackReportPartFail644(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InstitutionBalanceSheetDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_644);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_644);
