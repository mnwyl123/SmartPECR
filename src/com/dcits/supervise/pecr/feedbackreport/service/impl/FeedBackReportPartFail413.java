...
public class FeedBackReportPartFail413 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail413.class);
	
	public FeedBackReportPartFail413(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("EnAcctInfDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_413);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_413);
