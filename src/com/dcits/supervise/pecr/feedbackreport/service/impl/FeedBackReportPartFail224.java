...
public class FeedBackReportPartFail224 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail224.class);
	
	public FeedBackReportPartFail224(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InCtrctEntDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_224);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_224);
