...
public class FeedBackReportPartFail634 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail634.class);
	
	public FeedBackReportPartFail634(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("CashFlowsDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_634);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_634);
