...
public class FeedBackReportPartFail614 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail614.class);
	
	public FeedBackReportPartFail614(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("BalanceSheetDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_614);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_614);
