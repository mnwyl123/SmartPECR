...
public class FeedBackReportPartFail213 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail213.class);
	
	public FeedBackReportPartFail213(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InAcctDel");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_213);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_213);
