...
public class FeedBackReportPartFail231 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail231.class);
	
	public FeedBackReportPartFail231(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InSecAcctIDCagsInf");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_231);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_231);
