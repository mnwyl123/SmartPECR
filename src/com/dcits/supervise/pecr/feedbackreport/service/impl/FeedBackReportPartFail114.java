...
public class FeedBackReportPartFail114 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail114.class);
	
	public FeedBackReportPartFail114(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("InBsInfDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_114);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_114);
