...
public class FeedBackReportPartFail222 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail222.class);
	
	public FeedBackReportPartFail222(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("InCtrctMdfc");
		Element sgmt = bas.element("BsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_222);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_222);
