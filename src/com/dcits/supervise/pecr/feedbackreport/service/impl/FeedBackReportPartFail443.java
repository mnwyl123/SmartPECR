...
public class FeedBackReportPartFail443 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail443.class);
	
	public FeedBackReportPartFail443(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_443);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_443);
