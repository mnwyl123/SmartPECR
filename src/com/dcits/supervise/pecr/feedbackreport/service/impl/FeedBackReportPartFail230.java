...
public class FeedBackReportPartFail230 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail230.class);
	
	public FeedBackReportPartFail230(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("InSecAcctInf");
		Element sgmt = bas.element("GuarAcctBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_230);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_230);
