...
public class FeedBackReportPartFail654 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail654.class);
	
	public FeedBackReportPartFail654(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element sgmt = rootElt.element("IncomeAndExpenseStatementDlt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_654);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_654);
