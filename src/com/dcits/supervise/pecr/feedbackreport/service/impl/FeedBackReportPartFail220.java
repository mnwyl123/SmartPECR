...
public class FeedBackReportPartFail220 extends FeedBackReportPartFailService{

	private ReportFeedBackMessageMapper reportFeedBackMessageMapper;
	
	private static final Logger logger = LoggerFactory.getLogger(FeedBackReportPartFail220.class);
	
	public FeedBackReportPartFail220(ReportFeedBackMessageMapper reportFeedBackMessageMapper){
	...
	String selectIdByJSONObject(Document reportDocument) throws Exception {
		...
		Element bas = rootElt.element("InCtrctInf");
		Element sgmt = bas.element("CtrctBsSgmt");
		String table_name = ReportType.getReportTypeBaseTable(ReportType.REPORT_220);
		String pk = ReportType.getReportTypePrimaryKey(ReportType.REPORT_220);
