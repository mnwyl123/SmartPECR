...
public class ConfigTools
{
  ...
  public static void main(String[] args)
    throws Exception
  {
    //String password = "SENSE1";
    String[] arr = genKeyPair(512);
    System.out.println("privateKey:" + arr[0]);
    System.out.println("publicKey:" + arr[1]);
    //System.out.println("password:" + encrypt(arr[0], password));
    System.out.println(decrypt("MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBALt6biMBOxfvWazaXgIFd8h0wNhpEb8DLGRHNnWYRWbh7C1e95+kF9io4I1vmhOblQdYKxD5yR0h5D+mTToGzo8CAwEAAQ==",
    		"CrioHLUmngP9uTt2T9nCzz8ipKi2k7OdttKBelzjlub39/BWK3M92YsMt6mMQtcgVU0Yvy7mSK+SPDTCravLDg=="));
