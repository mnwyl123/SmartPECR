...
import com.dcits.supervise.pecr.util.json.JSONTokener;
    ...
    throws JSONException
  {
    ...
    while (true) {
      ...
      if ((Character.isLetterOrDigit(c)) || (c == '#')) {
        sb.append(Character.toLowerCase(c)); } else {
        if (c == ';') {
          break;
        }
    ...
    return object != null ? object : new StringBuilder().append(ampersand).append(string).append(";").toString();
  }
    ...
    throws JSONException
  {
    ...
    case '\'':
      ...
      while (true) {
        ...
        if (c == '&') {
          sb.append(nextEntity(c)); continue;
        }
        sb.append(c);
      }
