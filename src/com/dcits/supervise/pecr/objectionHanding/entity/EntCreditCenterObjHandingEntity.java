 ...
 */
public class EntCreditCenterObjHandingEntity implements Serializable {

    private static final long serialVersionUID = -309562432014775419L;
	...
	public String getEntIDNum() {
		return entIDNum;
	}

	public void setEntIDNum(String entIDNum) {
		this.entIDNum = entIDNum;
	}
