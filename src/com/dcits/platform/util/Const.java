...
public class Const {
	...
	public static final String BCRFILEPATHFILE = "BcrFileDeal/file/";		//文件上传路径
	public static final String FILEPATHTWODIMENSIONCODE = "uploadFiles/twoDimensionCode/"; //二维码存放路径
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(static)|(main)|(left)|(websocket)|(ssoEntry)).*";	//不对匹配该值的访问路径拦截（正则） maff 在2017/7/6进行添加ssoEntry 
