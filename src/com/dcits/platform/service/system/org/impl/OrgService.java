...
/*	@Override
	...
	public Map<String, ? extends Object> getOrgTree(Map<String, Object> param) throws Exception {
		...
		//获取所有机构信息
		@SuppressWarnings("unchecked")
		List<TreeDetails> tds = (List<TreeDetails>) dao.findForList("OrgMapper1.listAllOrgByCompany", company);
	...
	@Override
	public List<String> listSonOrg(PageData pd) throws Exception {
		return (List<String>) dao.findForList("OrgMapper.listSonOrg", pd);
	}

	@Override
	public List<String> findOrgCode(PageData pd) throws Exception {
		return (List<String>) dao.findForList("OrgMapper.findOrgCode", pd);
	}
	
	@Override
	public void listAllSonOrg(PageData pd) throws Exception {
		String allorg = (String) pd.get("allOrgString");
		allorg = allorg+pd.get("ORG_CODE");
		pd.put("allOrgString", allorg);
		List<String> list1 =(List<String>) dao.findForList("OrgMapper.listSonOrg", pd);
		if(list1.size()!=0){
			for(int i = 0;i<list1.size();i++){
				allorg = (String) pd.get("allOrgString");
				allorg=allorg+",";
				pd.put("ORG_ID", list1.get(i));
				List<String> list2 =(List<String>) dao.findForList("OrgMapper.findOrgCode", pd);
				pd.put("ORG_CODE",list2.get(0));
				pd.put("allOrgString", allorg);
				listAllSonOrg(pd);
			}
		}
	...
	/**
	 * Themis通过USER_ID获取机构信息
	 */
	@SuppressWarnings("unchecked")
	public List<Org> getOrgByUserIdFin(PageData pd)throws Exception{
		return (List<Org>)dao.findForList("OrgMapperFin.findOrgByUserId", pd);
	}
	
	@Override
	public List<String> getChildStringList(PageData pd)
			throws Exception
	{
		return (List)dao.findForList("OrgMapper.getChildStringList", pd);
	}

	@Override
	public List<Org> getChildOrgList(PageData pd) throws Exception
	{
		return (List)dao.findForList("OrgMapper.getChildOrgList", pd);
	}

	@Override
	public List<PageData> getReportOrgList(PageData pd) throws Exception
	{
		return (List<PageData>) dao.findForList("OrgMapper.getReportOrgList", pd);
	}
