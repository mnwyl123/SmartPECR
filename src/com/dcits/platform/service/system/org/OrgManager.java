...
public interface OrgManager{
	...
	List<String> listSonOrg(PageData pd) throws Exception;
	
	List<String> findOrgCode(PageData pd) throws Exception;
	
	public void listAllSonOrg(PageData pd) throws Exception;
	
	public List<Org> getOrgByUserIdFin(PageData pd)throws Exception;
	
	public List<String> getChildStringList(PageData paramPageData) throws Exception;

	public List<Org> getChildOrgList(PageData paramPageData) throws Exception;
