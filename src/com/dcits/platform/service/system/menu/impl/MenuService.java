...
//		return menuList;
	...
	@Override
	public List findMenuList(PageData pd) throws Exception {
		return (List)dao.findForList("MenuMapper.findMenuList", pd);
	}
	
	@Override
	@SuppressWarnings("unchecked")
	public List<String> getRoleIdsByUserNameFin(String userName, String company) throws Exception {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("userName", userName);
		map.put("company", company);
		List<String> roleIds = (List<String>) dao.findForList("MenuMapperFin.getRoleIdByUserName", map);
		return roleIds;
	}
}
