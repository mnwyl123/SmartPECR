...
public class MenuFunGroupController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@Operate(modulName = "新增menuFunGroup")
	 ...
	 * @throws Exception
	 */
	@Operate(modulName = "删除menuFunGroup")
	 ...
	 * @throws Exception
	 */
	@Operate(modulName = "修改menuFunGroup")
	 ...
	 * @throws Exception
	 */
	@Operate(modulName = "批量删除menuFunGroup")
...
//		List<PageData> varOList = MenuFunGroupService.listAll(pd);
		...
		for(int i=0;i<groupId.length;i++){
			...
			pd1.put("FUN_GROUP_ID", groupId[i]);
			PageData group = MenuFunGroupService.findById(pd1);
			PageData vpd = new PageData();
			vpd.put("var1", group.get("FUN_GROUP_ID"));
			vpd.put("var2", group.get("FUN_GROUP_NAME"));	    //1
			vpd.put("var3", group.get("FUN_GROUP_NAME_EN"));	    //2
			vpd.put("var4", group.get("FUN_GROUP_DESC"));	//3
			varList.add(vpd);
		}
		dataMap.put("varList", varList);
		dataMap.put("menuname", "MenuGroup");
