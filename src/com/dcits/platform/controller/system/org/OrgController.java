...
//			suserService.saveOrgAuth(map); 	//执行保存	
//		}
		orgService.save(pd);
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.addObject("menuId", pd.getString("menuId")); // 传入上级所有信息
