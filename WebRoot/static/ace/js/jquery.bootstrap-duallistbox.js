;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '列表 {0}',                                                        // text when all options are visible / false for no info text
  ...
  function refreshInfo(dualListbox) {
    ...
    if (all1 === 0) {
      content = dualListbox.settings.infoTextEmpty;
    	...
    	if(dualListbox.settings.leftTitle!=null){
    		content = dualListbox.settings.leftTitle
    	}else{
    ...
    if (all2 === 0) {
      content = dualListbox.settings.infoTextEmpty;
    	...
    	if(dualListbox.settings.rightTitle!=null){
    		content = dualListbox.settings.rightTitle
    	}else{
