...
//							verify.dataValidation('base','E_ACCT_BS',dataObj.edaAcctBsSgmtId,'form',true,false); //数据校验
			...
			table.render({
				...
				cols : [[
					...
					{align:"center",field:"arlpIdType",title:"身份类别",templet:function(d){return renderColDict(d,'arlpIdType',enterDict.infoIdType)}},
					...
					{align:"center",field:"arlpType",title:"还款责任人类型",templet:function(d){return renderColDict(d,'arlpType',enterDict.entLoanArlpType)}},
		...
		/****************************************初始债权说明段开始****************************************/
			...
			table.render({
				...
				cols : [[
					...
					{align:"center",field:"CHAN_TRAN_TYPE",title:"交易类型",templet:function(d){return renderColDict(d,'CHAN_TRAN_TYPE',enterDict.entLoanChanTranType)}},
