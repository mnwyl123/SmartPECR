    ...
    require(['static/js/pecr/module/base','static/js/pecr/module/config'],function(base,config){
		...
		*/
        ...
        var initEnumerationValue = function () {
			var array = ['ENT_GUAR_ACCT_TYPE','ENT_GUAR_RPT_DATE_CODE', 'ENT_GUAR_BUSI_LINES', 'ID_TYPE', 'CURRENCY', 
        ...
        $.when(d0,d1).done(function (d0,d1) {
            ...
            form.on('submit(baseSaveBtn)', function(data){
				...
				//提交
				$.ajax({  
					url      : 'enSecAcctInfSeo/saveEnSecAcctInf.do', 
            ...
            $("#baseDelBtn").on("click",function () {
                ...
                layer.confirm('删除基础段相当于删除该页面所有段信息，是否确认删除', {anim: 6}, function(index){
					...
					//提交
					$.ajax({ 
						url      : 'enSecAcctInfSeo/delEnSecAcctInf.do', 
            ...
            if (dataObj && guarAcctBsInfSgmt){
				...
				$("#othRepyGuarWay").val(guarAcctBsInfSgmt.OTH_REPY_GUAR_WAY);
            ...
            form.on('submit(basicSaveBtn)', function(data){
				...
				//提交
				$.ajax({  
					url      : 'enSecAcctInfSeo/saveGuarAcctBsInfSgmt.do', 
            ...
            $("#basicDelBtn").on("click",function () {
                ...
                layer.confirm('确认删除', {anim: 6}, function(index){
                    ...
                    para.eebGuarAcctBsInfSgmtId = $this.data("id");
					$.ajax({ 
						url      : 'enSecAcctInfSeo/guarAcctBsInfSgmtDel.do', 
						data     : {str : JSON.stringify(para)},
						type     : 'post',  
						cache    : false,  
						dataType : 'json',  
            ...
            var rltInfoUrl;
			if(pageType === 'edit'){
				rltInfoUrl = 'enSecAcctInfSeo/getRltInfList.do?eeaGuarAcctBsSgmtId='+ dataObj.eeaGuarAcctBsSgmtId 
						+ "&pageType=" + pageType;
				$("#responsibleAddBtn").parent().children('div.layui-colla-content').addClass('layui-show');
			} else {
				rltInfoUrl = 'enSecAcctInfSeo/getRltInfList.do?pageType='+ pageType;
			}
            ...
            table.on('tool(responsibleDataTable)', function(obj){
                ...
                if (layEvent === 'edit'){ //编辑
					...
					layer.confirm('确认删除该数据信息?', {anim: 6}, function(index){
						$.ajax({ 
							url      : 'enSecAcctInfSeo/rltRepymtInfDel.do', 
							data     : {str : JSON.stringify(para)},
							type     : 'post',  
							cache    : false,  
							dataType : 'json',  
            ...
            form.on('submit(saveResponsibleModelBtn)', function(data){
				$.ajax({
					type : "POST",  //请求方式
					url  : "enSecAcctInfSeo/saveRltRepymtInf.do",
            ...
            var mccInfoUrl;
			if(pageType === 'edit'){
				mccInfoUrl = 'enSecAcctInfSeo/getMccInfList.do?eeaGuarAcctBsSgmtId='+ dataObj.eeaGuarAcctBsSgmtId 
						+ "&pageType=" + pageType;
				$("#mortgageAddBtn").parent().children('div.layui-colla-content').addClass('layui-show');
			} else {
				mccInfoUrl = 'enSecAcctInfSeo/getMccInfList.do?pageType='+ pageType;
			}
            ...
            table.on('tool(mortgageDataTable)', function(obj){
                ...
                if (layEvent === 'edit'){ //编辑
					...
					layer.confirm('确认删除该数据信息?', {anim: 6}, function(index){
						$.ajax({ 
							url      : 'enSecAcctInfSeo/mccInfDel.do', 
							data     : {str : JSON.stringify(para)},
							type     : 'post',  
							cache    : false,  
							dataType : 'json',  
            ...
            form.on('submit(saveMortgageModelBtn)', function(data){
				$.ajax({
					type : "post",  //请求方式
					url  : "enSecAcctInfSeo/saveMccInf.do",
            ...
            form.on('submit(insuranceSaveBtn)', function(data){
				...
				//提交
				$.ajax({  
					url      : 'enSecAcctInfSeo/saveRepymtInfSgmt.do', 
					data     : {str:JSON.stringify(para), pageType : $this.data("type")},
					type     : 'post',  
					cache    : false,  
					dataType : 'json',  
            ...
            $("#insuranceDelBtn").on("click",function () {
                ...
                layer.confirm('确认删除', {anim: 6}, function(index){
                    ...
                    para.eefGuarRltRepymtInfSgId = $this.data("id");
                    $.ajax({ 
						url      : 'enSecAcctInfSeo/delRepymtInfSgmt.do',
						data     : {str : JSON.stringify(para)},
						type     : 'post',  
						cache    : false,  
						dataType : 'json',  
            ...
            form.on('submit(acctCredSgmtSaveBtn)', function(data){
				...
				//提交
				$.ajax({  
					url      : 'enSecAcctInfSeo/saveAcctCredSgmt.do', 
					data     : {str:JSON.stringify(para), pageType : $this.data("type")},
					type     : 'post',  
					cache    : false,  
					dataType : 'json',  
            ...
            $("#acctCredSgmtDelBtn").on("click",function () {
                ...
                layer.confirm('确认删除', {anim: 6}, function(index){
                    ...
                    para.eeeGuarAcctCredSgmtId = $this.data("id");
                    $.ajax({ 
						url      : 'enSecAcctInfSeo/delAcctCredSgmt.do',
						data     : {str : JSON.stringify(para)},
						type     : 'post',  
						cache    : false,  
						dataType : 'json',  
