	...
	form.on('select(orgCode)', function(data){
	 ...
	 $.when(d0,d1).done(function (d0,d1) {
		 $("#feedBackError").val(feedBackError);
            ...
            if (base.getrequest('type',true) === 'detail'){
       ...
       /**
         ...
         * 点击按段更正按钮
         */
        $("#baseSegmentChangeBtn,#basicSegmentChangeBtn,#responsibleSegmentChangeBtn,#behaviorSegmentChangeBtn,#businessSegmentChangeBtn").on("click",function () {
