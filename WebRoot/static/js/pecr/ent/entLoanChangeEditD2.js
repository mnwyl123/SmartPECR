...
layui.use(['element', 'form','layer','laydate','table','laytpl'], function(){
	...
	require(['static/js/pecr/module/base','static/js/pecr/module/verify'],function(base,verify){
		...
		var acctBsSgmt, acctBsInfSgmt, lbltyInfSgmt,feedBackError;
		if(pageType === 'edit'){
			//基础段
...
//							verify.dataValidation('base','E_ACCT_BS',dataObj.edaAcctBsSgmtId,'form',true,false); //数据校验
            ...
            if (base.getrequest('addOrUpdate',true) === 'detail'){
                ...
                if (dataObj.businessStates === 'RKCG'){ //入库成功状态
                    ...
                    $("#baseSegmentChangeBtn,#basicSegmentChangeBtn,#responsibleSegmentChangeBtn,#behaviorSegmentChangeBtn,#businessSegmentChangeBtn").show().css("visibility","visible").removeClass("hide");
                }
