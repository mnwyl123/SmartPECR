...
layui.use(['form', 'laydate', 'element', 'layer', 'table', 'laypage', 'laytpl', 'util'], function () {
    ...
    require(['static/js/pecr/module/base', 'static/js/pecr/module/verify'], function (base, verify) {
        ...
        $("#entName").val(ToCheckObjection.ENT_NAME);
        $("#entIDType").val(ToCheckObjection.ENT_ID_TYPE);
        $("#entIDNum").val(ToCheckObjection.ENT_ID_NUM);
...
//展示历史核查信息
        table.render({
            ...
            , url: 'entObjWebService/getHistoricalCheckInfList.do?creditCenterObjHandingId=' + ToCheckObjection.CREDIT_CENTER_OBJ_HANDING_ID
            , cols: [[
                {type: 'numbers'}	//列每行序号
        ...
        table.render({
            ...
            , url: 'entObjWebService/getLocateInfList.do?creditCenterObjHandingId=' + ToCheckObjection.CREDIT_CENTER_OBJ_HANDING_ID
            , cols: [[
                {type: 'numbers'}	//列每行序号
