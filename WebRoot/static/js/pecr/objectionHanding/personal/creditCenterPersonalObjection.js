...
layui.use(['layer', 'form', 'laydate', 'element', 'layer', 'table', 'laypage', 'laytpl', 'util'], function () {
    ...
    require(['static/js/pecr/module/base', 'static/js/pecr/module/verify'], function (base, verify) {
        ...
        table.render({
            ...
            , url: 'indvObjWebService/objectionDataList.do' //url
            , cols: [[
                {type: 'numbers'}	//列每行序号
                , {type: 'radio'} //列复选框
                ...
                , {
                    align: "center", field: 'idType', title: '证件类型', template: function (d) {
                        return renderColumnDict(d, 'idType', staticDict.idType)
                    }
                }
            ...
            , getAnnex: function () {
                ...
                if (checkStatus.data.length === 0) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        //请求地址
                        url: "indvObjWebService/getObjAnnex.do?messageType=G103",
                        //数据，json字符串
            ...
            , queryAccept: function () {
                ...
                if (checkStatus.data.length === 0) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        //请求地址
                        url: "indvObjWebService/findReceiveResult.do?messageType=G107",
                        //数据，json字符串
                        data: checkStatus.data[0],
                        //请求成功
                        success: function (result) {
            ...
            , deleteLabel: function () {
                ...
                if (checkStatus.data.length === 0) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        //请求地址
                        url: "indvObjWebService/deleteObjLabel.do?messageType=G111",
                        //数据，json字符串
                        data: checkStatus.data[0],
                        //请求成功
                        success: function (result) {
...
//监听submit提交-获取待核查异议输入
        form.on('submit(submitObjPanel)', function (data) {
            ...
            $.ajax({
                ...
                type: "POST",
                //请求地址
                url: "indvObjWebService/getToCheckObjection.do?messageType=G101",
                //数据，json字符串
                data: data.field,
                //请求成功
                success: function (result) {
        ...
        form.on('submit(submitFeedbackCheck)', function (data) {
            ...
            $.ajax({
                ...
                type: "POST",
                //请求地址
                url: "indvObjWebService/feedbackCheckResult.do?messageType=G105",
                //数据，json字符串
                data: data.field,
                //请求成功
                success: function (result) {
        ...
        form.on('submit(submitFeedbackCorrect)', function (data) {
            ...
            $.ajax({
                ...
                type: "POST",
                //请求地址
                url: "indvObjWebService/feedbackCorrectResult.do?messageType=G106",
                //数据，json字符串
                data: checkStatus.data[0],
                //请求成功
                success: function (result) {
        ...
        form.on('submit(submitAddLabel)', function (data) {
            ...
            $.ajax({
                ...
                type: "POST",
                //请求地址
                url: "indvObjWebService/addObjLabel.do?messageType=G109",
                //数据，json字符串
                data: checkStatus.data[0],
                //请求成功
                success: function (result) {
        ...
        table.on('tool(tableDemo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                layer.open({
                    ...
                    anim: 2,
                    resize: false,
                    content: 'indvObjWebService/objectionDetail.do?creditCenterObjHandingId=' + data.creditCenterObjHandingId,
                    end: function () {
                        table.reload('idTableRender', {
                            'where': {
                                'objCheckId': $('#objCheckId').val(),
                ...
                layer.confirm('确定删除该条数据?', function (index) {
                    $.ajax({
                        ...
                        type: "POST",
                        //请求地址
                        url: "indvObjWebService/deleteToCheckObjection.do",
                        //数据，json字符串
                        data: data,
                        //请求成功
                        success: function (result) {
