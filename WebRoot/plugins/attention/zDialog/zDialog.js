  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td height="30" style="background-color:'+ this.TitleBgc +' !important; '+ this.style +'" class="'+ this.TitleClass +'"><div style="padding: 5px 0 1px 7px; float: left; width:92%;text-align:center; color:#fff;letter-spacing:2px;"><span id="_Title_' + this.ID + '" class="bigger-160">' + this.Title + '</span></div>\
        <div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" class="glyphicon glyphicon-remove bigger-160" style="color:#ffffff;margin-top:5px; position: relative; cursor: pointer; float: right; height: 17px; width: 28px;' + (this.ShowCloseButton ? "" : "display:none;") + '"></div></td>\
      </tr>\
    <tr valign="top">\
