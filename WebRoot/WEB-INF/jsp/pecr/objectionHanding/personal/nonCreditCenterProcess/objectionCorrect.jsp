...
<script type="text/html" id="toolbarDemo">
    <button class="layui-btn layui-btn-xs layui-btn-normal layui-btn-radius" id="submitBtn" lay-event="submitBtn">更正完成
...
<script type="text/javascript">
    ...
    layui.use(['form', 'laydate', 'element', 'layer', 'table', 'laypage', 'laytpl'], function () {
        ...
        var loadDataOS = "50";//用来判断加载处于那个状态的异议列表-待更正
        var objType = "CHECK";
        ...
        table.on('toolbar(tableDemo)', function (obj) {
            switch (obj.event) {
                case 'submitBtn'://更正完成
                    ...
                    var objectionStatus = "60";//60-更正完成，流程结束
                    if (data.length == 0) {
