    ...
    <form class="layui-form layui-form-pane" lay-filter="editForm" id="editForm">
        <div class="layui-form-item" style="margin-left:30px;">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="custName" id="custName" readonly autocomplete="off" class="layui-input"/>
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">证件类型</label>
                <div class="layui-input-inline">
                    <select lay-search="" name="idType" id="idType" readonly>
                        <option value="">请选择</option>
                    </select>
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">证件号码</label>
                <div class="layui-input-inline">
                    <input type="text" name="idNum" id="idNum" readonly autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">异议信息类型</label>
                <div class="layui-input-inline">
                    <select lay-search="" name="objectionType" id="objectionType" readonly>
                        <option value="">请选择</option>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select lay-search="" name="isLabel" readonly id="isLabel">
                        <option value="">请选择</option>
                    </select>
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <textarea name="objectionRegistRemark" readonly placeholder="请输入备注" id="objectionRegistRemark"
...
<script type="text/html" id="toolbarDemo">
    ...
    <button class="layui-btn layui-btn-xs layui-btn-normal layui-btn-radius" id="submitBtn" lay-event="submitBtn">提交审核
...
<script type="text/javascript">
    ...
    layui.use(['form', 'laydate', 'element', 'layer', 'table', 'laypage', 'laytpl'], function () {
        ...
        var loadDataOS = "20";//用来判断加载处于那个状态的异议列表-待资料核查
        var objType = "CHECK";
        ...
        table.on('toolbar(tableDemo)', function (obj) {
            switch (obj.event) {
                ...
                case 'submitBtn'://提交下一环节处理
                    ...
                    //获取选中行的数据
                    data = checkStatus.data;
                    var objectionStatus = "30";//30-待审核状态
                    if (data.length == 0) {
                        layer.msg("请选择需要提交的数据!");
                        return;
                    }
