    ...
    <form class="layui-form layui-form-pane" lay-filter="editForm" id="editForm">
        <div class="layui-form-item" style="margin-left:30px;">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <textarea name="approveRemark" placeholder="请输入备注" id="approveRemark"
                              class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-inline">
...
<script type="text/html" id="toolbarDemo">
    <button class="layui-btn layui-btn-xs layui-btn-radius" lay-event="stopBtn" id="stopBtn">打回<i
            class="layui-icon layui-icon-addition"></i></button>
    <button class="layui-btn layui-btn-xs layui-btn-normal layui-btn-radius" id="submitBtn" lay-event="submitBtn">审批通过
...
<script type="text/javascript">
    ...
    layui.use(['form', 'laydate', 'element', 'layer', 'table', 'laypage', 'laytpl'], function () {
        ...
        var loadDataOS = "40";//用来判断加载处于那个状态的异议列表-待审批
        var objType = "CHECK";
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {align: "center", field: 'approveRemark', title: '审批备注'}
                , {
        ...
        table.on('toolbar(tableDemo)', function (obj) {
            switch (obj.event) {
                ...
                case 'submitBtn'://提交下一环节处理
                    ...
                    //获取选中行的数据
                    data = checkStatus.data;
                    var objectionStatus = "50";//50-数据待更正状态
                    if (data.length == 0) {
                        layer.msg("请选择需要提交的数据!");
                        return;
                    }
