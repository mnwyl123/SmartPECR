            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item layui-layer-padding">
                    ...
                    <div class="layui-inline layui-col-xs2" style="margin-bottom: 40px;">
                        ...
                        <div class="layui-input-inline" style="width: 100%;">
                            <input type="text" placeholder="" class="layui-input" id="name" lay-verify="required"
                                   maxlength="20">
                        </div>
                    </div>
                    <div class="layui-inline layui-col-xs2" style="margin-bottom: 40px;">
                    ...
                    <div class="layui-inline layui-col-xs2" style="margin-bottom: 40px;">
                        ...
                        <div class="layui-input-inline" style="width: 100%;">
                            <input type="text" placeholder="" class="layui-input" id="idNum"
...
<script src="static/js/pecr/objectionHanding/personal/creditCenterPersonalObjectionDetail.js"></script>
</body>
</html>
