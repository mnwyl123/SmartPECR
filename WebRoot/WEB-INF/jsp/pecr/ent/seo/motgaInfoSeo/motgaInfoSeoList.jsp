		  ...
		  <div class="layui-colla-content layui-show">
			<div class="layui-form-item">
				<div class="layui-inline">
				  <label class="layui-form-label">抵（质）押合同标识码</label>
				  <div class="layui-input-inline">
					<input type="text" name="CC_CODE" id="CC_CODE" autocomplete="off"  class="layui-input"/>
				  </div>
				</div>
...
//展示已知数据
  table.render({
	...
	,url:'motgaInfoSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'CC_CODE', title: '抵（质）押合同标识码'}
      ,{align : "center",field: 'NAME', title: '客户姓名'}
      ,{align : "center",field: 'ID_NUM', title: '身份标识码'}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'motgaInfoSeo/listHistPage.do?CC_CODE=' + data.CC_CODE,
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
