...
//展示已知数据
  table.render({
	...
	,url:'enSecAcctInfSeo/dataHistListForUpdate.do?ACCT_TYPE=' + dataObj.ACCT_TYPE+"&ACCT_CODE="+dataObj.ACCT_CODE //url
    ,cols: [[ 
    	{type:'numbers'},	//列每行序号
		{type:'checkbox'},  //列复选框
...
//		{field: 'mngmtOrgCode', align:'center', title: '所属机构'},
        ...
        {field: 'idType', align:'center', title: '身份标识类别', templet: function(d){return renderColumnDict(d,'idType',enterDict.arlpCertType)}},
		...
		{field: 'mdfcSgmtCode', align:'center', title: '待更正段段标',templet: function(d){return renderColumnDict(d, 'mdfcSgmtCode', enterDict.entGuarUpInfRecType)}},
    ...
    if(obj.event === 'more'){
    	if(flag === 'new'){
			...
			layer.open({
				...
				anim: 2,
				resize: false,
				content: 'entUpDaccountData/entGuaranteeChangeEdit.do?addOrUpdate=' + addOrUpdate
        	  ...
        	  $("body").data("dataObj",data);
	  			...
	  			layer.open({
			         ...
			         + '&eeaGuarAcctBsSgmtId=' + data.eeaGuarAcctBsSgmtId
			         + "&queryType=entGuarUpdateBySegment",
	  				end: function(){
	  					tableReload(); 
	  				}
	  			});
