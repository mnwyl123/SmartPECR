...
//展示已知数据
  table.render({
	...
	,url:'enSecAcctInfSeo/dataListForUpdate.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'ACCT_TYPE', title: '账户类型', templet: function(d){return renderColumnDict(d,'ACCT_TYPE',enterDict.entGuarAcctType)}}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'enSecAcctInfSeo/listHistPageForUpdate.do',
		end: function(){
			table.reload('tableDemo',{
				  method : 'post',
					where: {
