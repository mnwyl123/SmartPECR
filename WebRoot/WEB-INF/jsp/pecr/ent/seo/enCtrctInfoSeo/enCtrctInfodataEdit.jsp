...
<link rel="stylesheet" href="css/pecr/enterpriseProtocolInfo/enterpriseProtocolInfoEdit.css" media="all">
</head>
			...
			<div class="layui-collapse" >
						...
						<div class="layui-colla-content layui-show">
							<div class="layui-form-item layui-layer-padding">
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="infRecType" lay-verify="required" disabled>
											<option value="420" selected>企业授信协议信息记录</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="idNum" lay-verify="required" maxlength="40">
									</div>
								</div>
								<!-- <div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
				...
				<div class="layui-colla-item">
					...
					<div class="layui-colla-content">
						<table class="layui-hide" id="commonDataTable" name="commonDataTable" style="margin-top: 10px;clear: both;" 
				...
				<!-- 额度信息段 start-->
				<div class="layui-colla-item">
					<form class="layui-form" id="amountform">
						<input type="button" id="amountAddBtn" 
							class="layui-btn layui-btn-xs pane-title-btn" value="新增"></input>
		...
		<div class="layui-form-item layui-col-xs12" style="width: 80%;margin: 30px 0 20px;text-align: center;">
			<div class="layui-inline layui-col-xs12">
				<div class="layui-input-inline" style="width: 100%;">
					...
					<button class="layui-btn layui-btn-custom-blue" id="delAllModelBtn" style="display: none;">删除，企业授信信息</button>
					<button class="layui-btn layui-btn-custom-blue" id="pushAllModelBtn" style="display: none;">提交，企业授信信息</button>
					<button class="layui-btn layui-btn-custom-blue" id="approvalAllBtn" style="display: none;">审批，企业授信信息</button>
					<button class="layui-btn layui-btn-custom-blue" id="overruleAllBtn" style="display: none;">驳回，企业授信信息</button>
...
<div id="commonEditModel" style="display: none;">
    <form class="layui-form" id="ctrctinf">
        <div class="layui-form-item layui-col-space20" style="margin: 0;">
			...
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
				...
				<div class="layui-input-inline" style="width: 100%;">
					<input type="text" placeholder="" class="layui-input" name="certRelName" id="certRelName" lay-verify="required" maxlength="80">
				</div>
			</div>
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
				<label class="layui-form-label" style="float:none;text-align: left;">
			...
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
				...
				<div class="layui-input-inline" style="width: 100%;">
					<input type="text" placeholder="" class="layui-input" name="certRelIdNum" id="certRelIdNum" lay-verify="required" maxlength="40">
				</div>
			</div>
        </div>
...
<script src="static/js/pecr/ent/seo/enCtrctInfoEdit.js" charset="utf-8"></script>
