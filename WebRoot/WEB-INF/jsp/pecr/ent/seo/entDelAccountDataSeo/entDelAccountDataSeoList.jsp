		  ...
		  <div class="layui-colla-content layui-show">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
				  ...
				  <div class="layui-input-inline">
					<input type="text" name="DEL_REC_CODE" id="DEL_REC_CODE" autocomplete="off"  class="layui-input"/>
				  </div>
				</div>
			</div>
		  </div>						  
...
//展示已知数据
  table.render({
	...
	,url:'entDelAccountSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'ID_TYPE', title: '企业身份标识类型', templet:function(d){return renderColumnDict(d,'ID_TYPE',enterDict.arlpCertType)}}
      ,{align : "center",field: 'ID_NUM', title: '企业身份标识号码'}
      ,{align : "center",field: 'DEL_REC_CODE', title: '待删除业务标识码'}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'entDelAccountSeo/listHistPage.do',
		end: function(){
			table.reload('tableDemo',{
				  method : 'post',
					where: {
