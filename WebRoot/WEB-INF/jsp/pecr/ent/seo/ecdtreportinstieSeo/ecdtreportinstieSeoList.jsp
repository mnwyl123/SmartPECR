...
//展示已知数据
  table.render({
	...
	,url:'ecdtreportinstieSeo/acctInfoList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'ENT_CERT_TYPE', title: '企业身份标识类型', templet:function(d){return renderColumnDict(d,'ENT_CERT_TYPE',enterDict.arlpCertType)}}	
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'ecdtreportinstieSeo/listHistPage.do',
		end: function(){
			table.reload('tableDemo',{
				  method : 'post',
					where: {
