		...
		<div class="layui-colla-item">
		  ...
		  <div class="layui-colla-content layui-show">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
				  <label class="layui-form-label">账户标识号码</label>
				  <div class="layui-input-inline">
...
//初始化性别下拉字典
initDict('ACCT_TYPE', enterDict.enLoanAcctType);
//弹出层id
var popIndex;
...
//展示已知数据
  table.render({
	...
	,url:'entLoanAcctInfoSeo/dataListForUpdate.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'entLoanAcctInfoSeo/listHistPageForUpdate.do',
		end: function(){
			table.reload('tableDemo',{
				  method : 'post',
					where: {
