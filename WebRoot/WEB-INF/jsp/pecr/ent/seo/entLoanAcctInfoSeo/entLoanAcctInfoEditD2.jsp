...
<link rel="stylesheet" href="css/pecr/enterpriseLoanInfo/enterpriseLoanInfoEditD2.css" media="all">
</head>
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="acctType" lay-verify="required" disabled>
											<option value="D2" selected>贴现账户</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
...
<script src="static/js/pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditD2.js" charset="utf-8"></script>
