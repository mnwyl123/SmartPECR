...
<link rel="stylesheet" href="css/pecr/enterpriseLoanInfo/enterpriseLoanInfoEditD1.css" media="all">
</head>
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="flag" lay-verify="required">
											<option value=""></option>
										</select>
									</div>
								</div>
...
<script src="static/js/pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditD1.js" charset="utf-8"></script>
