...
//展示已知数据
  table.render({
	...
	,url:'entLoanAcctInfoSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'ACCT_TYPE', title: '账户类型', templet:function(d){return renderColumnDict(d,'ACCT_TYPE',enterDict.enLoanAcctType)}}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'entLoanAcctInfoSeo/listHistPage.do',
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
