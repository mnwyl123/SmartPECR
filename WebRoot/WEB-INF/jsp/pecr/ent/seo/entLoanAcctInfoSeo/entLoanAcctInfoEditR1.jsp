...
<link rel="stylesheet" href="css/pecr/enterpriseLoanInfo/enterpriseLoanInfoEditR1.css" media="all">
</head>
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="infRecType" lay-verify="required" disabled>
											<option value="410" selected>企业借贷账户信息记录</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="acctType" lay-verify="required" disabled>
											<option value="R1" selected>循环贷账户</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="loaFrm" lay-verify="required">
											<option value=""></option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="actInvest" lay-search="">
											<option value=""></option>
										</select>
									</div>
								</div>
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="pymtPrd" lay-verify="required|threeValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="overdDy" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="latAgrrRpyDate" lay-verify="required" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="latAgrrRpyAmt" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="nxtAgrrRpyDate" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
...
<script src="static/js/pecr/ent/seo/entLoanAcctInfoSeo/entLoanAcctInfoEditR1.js" charset="utf-8"></script>
