...
initDict('infRecType', enterDict.entAbnlMesPage);
//弹出层id
var popIndex;
...
table.render({
  elem: '#tableDemo' //表格所固定的div
	...
	,url:'entAbnormalMessage/dataList.do' //url
  ,cols: [[ 
    {type:'numbers', fixed: 'left', width:50}	//列每行序号
    ,{type:'checkbox', width:50} //列复选框
    ,{field: 'RPTDATE', align:'center', title: '报送日期'}
    ,{field: 'INFRECTYPE', align:'center', title: '信息记录类型',templet: function(d){return renderColumnDict(d, 'INFRECTYPE',  enterDict.entAbnlMesPage)}}
...
table.on('toolbar(tableDemo)', function(obj){
	if(obj.event === 'generateMessage') {
		 ...
		 var normalOrAbnormal ="entabnormal";
		 if(data.length==0){
