	...
	<div class="layui-row layui-col-space15">
		<div class="layui-col-md12">
			<div class="layui-collapse" >
				...
				<div class="layui-colla-item" id="CtrctBsSgmtDiv">
					<form class="layui-form">
						...
						<input type="button" lay-filter="baseDelBtn"id="baseDelBtn" value="删除" style="display:none;margin-right:110px;"
						...
						<div class="layui-colla-content layui-show">
							<div class="layui-form-item layui-layer-padding">
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="infRecType" lay-verify="required" disabled>
											<option value="422" selected>企业授信协议按段更正请求记录</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="isFilter" lay-verify="required" disabled>
											<option value=""></option>
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="rptDate" lay-verify="required" disabled>
									</div>
								</div>
									<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						<label class="layui-form-label" style="float:none;text-align: left;">
				...
				<div class="demo" data-value="C" style="display: none;" >
					<div class="layui-colla-item" data-value="C" style="display: none;" id = "common">
				...
				<!-- 共同授信人信息段 end-->
				<!-- 额度信息段 start-->
				<div class="layui-colla-item" data-value="D" style="display:none;" id = "amount">
					<form class="layui-form">
				...
				<!-- 额度信息段 end-->
				<!-- 共同受信人信息段 -->
		        <div class="layui-colla-item" id="commonEditModel" style="display: none;">
   						 <form class="layui-form">
			...
			<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
				...
				<div class="layui-input-inline" style="width: 100%;">
					<select name="certRelIdType"id="certRelIdType" lay-verify="required">
						<option value=""></option>
					</select>
				</div>
			</div>
...
<script src="static/js/pecr/ent/entProtocolChangeEdit.js" charset="utf-8"></script>	
