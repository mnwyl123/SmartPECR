		  ...
		  <div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
			<div class="layui-form-item">
				<div class="layui-inline">
	                <label class="layui-form-label" style="width: 110px;">信用报告日期</label>
	                <div class="layui-input-inline">
	                    <input type="text" placeholder="" class="layui-input datefield" id="rptDate">
	                </div>
	            </div>
				<div class="layui-inline">
				  <label class="layui-form-label" style="width: 110px;">信息记录类型</label>
				  <div class="layui-input-inline">
				...
				<div class="layui-inline">
	                <label class="layui-form-label" style="width: 110px;">旧业务标识码</label>
	                <div class="layui-input-inline">
...
<script src="static/js/pecr/ent/entAccountChange.js" charset="utf-8"></script>
