		...
		<div class="layui-colla-item">
		  ...
		  <div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label" style="width: 110px;">受信人名称:</label>
					<div class="layui-input-inline">
						<div class="layui-input-inline">
						<input type="text" placeholder="" class="layui-input" id="name">
					</div>
					</div>
				</div>
				<div class="layui-inline">
...
<script src="static/js/pecr/ent/entProtocolChange.js" charset="utf-8"></script>
