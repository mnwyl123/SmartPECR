	...
	<div class="layui-row layui-col-space15">
		<div class="layui-col-md12">				
			<div class="layui-collapse" >
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="infRecType" name='infRecType' lay-verify="required" disabled>
											<option value="440" selected>企业担保账户信息记录</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="acctCode" name='acctCode'
										       lay-verify="required" maxlength="60">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
				...
				<div class="layui-colla-item">
					<form class="layui-form">
						<input type="button" id="acctCredSgmtAddBtn" style="display: none;"
							   class="layui-btn layui-btn-xs pane-title-btn" value="新增"></input>
						<input type="button" lay-filter="acctCredSgmtSaveBtn" id="acctCredSgmtSaveBtn" lay-submit style="display:none;"
						       class="layui-btn layui-btn-xs pane-title-btn" value="保存当前段"></input>
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="mcc" lay-verify="required" maxlength="60">
									</div>
								</div>
							</div>
						</div>
...
<script src="static/js/pecr/ent/EnSecAcctInf/enSecAcctInfEdit.js" charset="utf-8"></script>
