...
<div class="wrap">
	<div class="layui-form layui-form-pane" id="queryPanel">
		<div class="layui-colla-item">
		  ...
		  <div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					<label class="layui-form-label" style="width: 110px;">账户类型:</label>
					<div class="layui-input-inline">
				...
				<div class="layui-inline">
					<label class="layui-form-label" style="width: 110px;">账户标识码:</label>
					<div class="layui-input-inline">
						<input type="text" placeholder="" class="layui-input" id="acctCode">
					</div>
				</div>
				<div class="layui-inline">
	 ...
	 <!-- 数据渲染 -->
	<table class="layui-hide" id="enSecAcctInfTab" lay-filter="enSecAcctInfTab"></table>
</div> 
...
<script src="static/js/pecr/ent/EnSecAcctInf/enSecAcctInf.js" charset="utf-8"></script>
