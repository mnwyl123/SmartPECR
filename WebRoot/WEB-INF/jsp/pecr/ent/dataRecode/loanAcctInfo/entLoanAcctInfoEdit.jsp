	...
	<div class="layui-tab layui-tab-brief" lay-filter="loanAcctInfotab" style="height: 100%;">
		...
		<div class="layui-tab-content" style="position: absolute;left: 0;right: 0;top: 35px;bottom: 0;">
			<div data-type="D1" class="layui-tab-item layui-show" style="width: 100%;height: 100%;">
				<iframe src="" data-src="entLoanAcctInfo/entLoanAcctInfoEditD1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="D2" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="entLoanAcctInfo/entLoanAcctInfoEditD2.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="R1" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="entLoanAcctInfo/entLoanAcctInfoEditR1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="R4" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="entLoanAcctInfo/entLoanAcctInfoEditR4.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="C1" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="entLoanAcctInfo/entLoanAcctInfoEditC1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
		</div>
	</div>
</div>
...
<script src="static/js/pecr/ent/LoanAcctInfo/entLoanAcctInfoEdit.js" charset="utf-8"></script>
</body>
</html>
