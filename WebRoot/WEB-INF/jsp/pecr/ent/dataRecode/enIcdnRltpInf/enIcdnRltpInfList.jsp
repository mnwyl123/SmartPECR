...
<div class="wrap">
	<div class="layui-form layui-form-pane" id="queryPanel">
	 ...
	 <!-- 数据渲染 -->
	<table class="layui-hide" id="enIcdnRltpInfTab" lay-filter="enIcdnRltpInfTab"></table>
</div> 
...
<script src="static/js/pecr/ent/EnIcdnRltpInf/enIcdnRltpInf.js" charset="utf-8"></script>
