...
<input type="hidden" id="enIcdnRltpInf" value='${enIcdnRltpInf}'>
		...
		<div class="layui-col-md12">				
			<div class="layui-collapse" >
				...
				<div class="layui-colla-item" id="CtrctBsSgmtDiv">
					<form class="layui-form">
					<input type="button" lay-filter="baseAddBtn" id="baseAddBtn" style="display: none;"
						...
						<input type="button" id="baseDelBtn" lay-filter="baseDelBtn" value="删除" style="display:none;margin-right:110px;"
...
<script src="static/js/pecr/ent/EnIcdnRltpInf/enIcdnRltpInfEdit.js" charset="utf-8"></script>
