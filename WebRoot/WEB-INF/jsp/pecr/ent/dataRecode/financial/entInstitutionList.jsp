...
<div class="wrap">
	<div class="layui-form layui-form-pane" id="queryPanel">
	 ...
	 <!-- 数据渲染 -->
	<table class="layui-hide" id="entInstitutionTab" lay-filter="entInstitutionTab"></table>
</div> 
...
<script src="static/js/pecr/ent/financial/entInstitutionList.js" charset="utf-8"></script>
