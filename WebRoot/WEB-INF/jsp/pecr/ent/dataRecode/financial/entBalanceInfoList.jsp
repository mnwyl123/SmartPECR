...
<div class="wrap">
	<div class="layui-form layui-form-pane" id="queryPanel">
	 ...
	 <!-- 数据渲染 -->
	<table class="layui-hide" id="entBalanceTab" lay-filter="entBalanceTab"></table>
</div> 
...
<script src="static/js/pecr/ent/financial/entBalanceInfoList.js" charset="utf-8"></script>
