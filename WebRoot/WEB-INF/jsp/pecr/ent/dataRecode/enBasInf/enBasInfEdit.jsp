		...
		<div class="layui-col-md12">
			<div class="layui-collapse">
				...
				<div class="layui-colla-item" id="dcentBsSgmtDiv">
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="entCertType"  name="entCertType" lay-verify="required" lay-search="">
								<option value=""></option>
							</select>
						</div>
					</div>
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
					 ...
					 <div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							<select id="orgCode" name="orgCode" lay-verify="required" lay-search="" lay-filter= "orgCode">
								<option value=""></option>
							</select>
						</div>
					</div>
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="etpSts" lay-verify="required" lay-search="">
								<option value=""></option>
							</select>
						</div>
					</div>
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select lay-filter="orgType" id="orgType" lay-verify="required" lay-search="">
								<option value=""></option>
							</select>
						</div>
					</div>
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							<select id="isFilter"  lay-verify="required" lay-search="">
								<option value=""></option>
				...
				<div class="layui-colla-item" id="dcentFcsInfSgmtDiv">
					<form class="layui-form">
						<input type="button" id="dcentFcsInfSgmtAddBtn" lay-filter="dcentFcsInfSgmtAddBtn" style="display:none;"
							   class="layui-btn layui-btn-xs pane-title-btn" value="新增"></input>
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="admDivOfReg" lay-search="" lay-verify="required">
								<option value=""></option>
							</select>
						</div>
					</div>
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="entScale" lay-verify="required" lay-search="">
								<option value=""></option>
							</select>
						</div>
					</div>
				...
				<div class="layui-colla-content">
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="conAddDistrictCcode"  lay-verify="required" lay-search="" >
								<option value=""></option>
							</select>
						</div>
					</div>
				...
				<div class="layui-colla-item">
					<form class="layui-form">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="supOrgType" lay-verify="required" lay-search="">
								<option value=""></option>
							</select>
						</div>
					</div>
					...
					<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px;">
						...
						<div class="layui-input-inline" style="width: 100%;">
							...
							<select id="supOrgCertType" lay-verify="required" lay-search="">
								<option value=""></option>
							</select>
						</div>
					</div>
	...
	<form class="layui-form">
		<div class="layui-form-item layui-col-space20" style="margin: 0;">
			...
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
                ...
                <div class="layui-input-inline" style="width: 100%;">
                    <select lay-filter="actuCotrlCertType" id="actuCotrlCertType" lay-verify="required" lay-search="">
                        <option value=""></option>
                    </select>
                </div>
            </div>
			...
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
				...
				<div class="layui-input-inline" style="width: 100%;">
					<select id="actuCotrlIdType" lay-verify="required" lay-search="">
						<option value=""></option>
					</select>
				</div>
			</div>
        ...
        <div class="layui-form-item layui-row layui-col-space20" style="margin: 10px;">
            <div class="layui-inline layui-col-xs12">
                <div class="layui-input-inline" style="width: 100%;text-align: center;">
                    <button class="layui-btn layui-btn-primary" id="cancelentActuCotrlInfSgmtModelBtn" type="button">取消</button>
	...
	<form class="layui-form">
        <div class="layui-form-item layui-col-space20" style="margin: 0;">
            ...
            <div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
                ...
                <div class="layui-input-inline" style="width: 100%;">
                    <select id="othEntCertType"name="othEntCertType" lay-verify="required" lay-search="">
                        <option value=""></option>
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item layui-row layui-col-space20" style="margin: 10px;">
            <div class="layui-inline layui-col-xs12">
                <div class="layui-input-inline" style="width: 100%;text-align: center;">
                    <button class="layui-btn layui-btn-primary" id="cancelentIdSgmtModelBtn" type="button">取消</button>
	...
	<form class="layui-form">
		<div class="layui-form-item layui-col-space20" style="margin: 0;">
            ...
            <div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
                ...
                <div class="layui-input-inline" style="width: 100%;">
                    <select id="sharHodType" lay-verify="required" lay-search="">
                        <option value=""></option>
                    </select>
                </div>
            </div>
            <div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
                ...
                <div class="layui-input-inline" style="width: 100%;">
                    <select lay-filter="sharHodCertType" id="sharHodCertType" lay-verify="required" lay-search="">
                        <option value=""></option>
                    </select>
                </div>
            </div>
            ...
            <div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
                ...
                <div class="layui-input-inline" style="width: 100%;">
					<select lay-filter="sharHodIdType" id="sharHodIdType" lay-verify="required" lay-search="">
						<option value=""></option>
					</select>
                </div>
            </div>
            ...
            <div class="layui-form-item layui-row layui-col-space20" style="margin: 10px;">
	            <div class="layui-inline layui-col-xs12">
	                <div class="layui-input-inline" style="width: 100%;text-align: center;">
	                    <button class="layui-btn layui-btn-primary" id="cancelentMnShaHodInfSgmtModelBtn" type="button">取消</button>
	...
	<form class="layui-form">
		<div class="layui-form-item layui-col-space20" style="margin: 0;">
            ...
            <div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
                ...
                <div class="layui-input-inline" style="width: 100%;">
                    <select id="mmbIdType" lay-verify="required" lay-search="">
                        <option value=""></option>
                    </select>
                </div>
            </div>
			...
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px;">
				...
				<div class="layui-input-inline" style="width: 100%;">
					<select id="mmbPstn" lay-verify="required" lay-search="">
						<option value=""></option>
					</select>
				</div>
			</div>
			...
			<div class="layui-form-item layui-row layui-col-space20" style="margin: 10px;">
	            <div class="layui-inline layui-col-xs12">
	                <div class="layui-input-inline" style="width: 100%;text-align: center;">
	                    <button class="layui-btn layui-btn-primary" id="cancelentMnMmbInfSgmtModelBtn" type="button">取消</button>
...
<script src="static/js/pecr/ent/EnBasInf/enBasInfEdit.js" charset="utf-8"></script>
