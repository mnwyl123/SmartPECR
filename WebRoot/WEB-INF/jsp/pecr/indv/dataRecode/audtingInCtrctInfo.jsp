		...
		<div class="layui-colla-item">
			...
			<div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
				<div class="layui-form-item">
					...
					<label class="layui-form-label">授信人名称</label>
					<div class="layui-input-inline">
						<input type="text" name="name" id="name" autocomplete="off" class="layui-input"/>
					</div>
					</div>
					<div class="layui-inline">
					<label class="layui-form-label">授信人证件号码</label>
					<div class="layui-input-inline">
...
//展示已知数据
  table.render({
	...
	,url:'auditing/dataInCtrctInfo.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
		...
		switch (obj.event) {
			case 'auditingBtn':
				 ...
				 for(var i = 0; i < data.length; i++){
					 strIds+=checkStatus.data[i].pcaCtrctBsSgmtId+",";
				}
				  	...
				  	layer.open({
						...
						yes: function (index,layero){
							...
							$.ajax({ 
								...
								data     : {state:'30',strIds:strIds,auditOpinion:auditOpinion,tableName:'I_CTRCT_BS',tablePk:'PCA_CTRCT_BS_SGMT_ID'},
								type     : 'post',  
								cache    : false,  
								dataType : 'json',  
					  	...
					  	btn2: function (index,layero){
							...
							$.ajax({ 
								url      : 'auditing/isAuditing.do', 
								data     : {state:'40',strIds:strIds,auditOpinion:auditOpinion,tableName:'I_CTRCT_BS',tablePk:'PCA_CTRCT_BS_SGMT_ID'},
								type     : 'post',  
								cache    : false,  
								dataType : 'json',  
								success:function(result){ 
