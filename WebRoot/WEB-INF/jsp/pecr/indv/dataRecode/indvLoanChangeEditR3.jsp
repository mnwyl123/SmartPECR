...
<link rel="stylesheet" href="css/pecr/personLoanInfo/personLoanInfoEditR3.css" media="all">
</head>
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="acctType" lay-verify="required" disabled>
											<option value="R3" selected>准贷记卡账户</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="ovedrawBaOve180" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
				...
				<div class="layui-colla-item" style="display:none;" data-value="J">
					<form class="layui-form">
						<input type="button" id="noBehaviorAddBtn" style="display:none;" value="新增"
							   class="layui-btn layui-btn-xs pane-title-btn"></input>
						<input type="button" lay-filter="noBehaviorSaveBtn" lay-submit id="noBehaviorSaveBtn"  style="display:none;"
...
<script src="static/js/pecr/indv/indvLoanChangeEditR3.js" charset="utf-8"></script>
