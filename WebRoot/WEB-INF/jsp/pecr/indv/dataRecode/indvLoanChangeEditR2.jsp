...
<link rel="stylesheet" href="css/pecr/personLoanInfo/personLoanInfoEditR2.css" media="all">
</head>
	...
	<div class="layui-row layui-col-space15">
		<div class="layui-col-md12">
			<div class="layui-collapse">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<select id="acctType" lay-verify="required" disabled>
											<option value="R2" selected>贷记卡账户</option>
										</select>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="creditId" lay-verify="required|creditIdLength">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="settDate" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="pridAcctBal" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="usedAmt" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="notIsuBal" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="fiveCateAdjDate" lay-verify="required" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="rpyPrct" lay-verify="threeValue">
									</div>
								</div>
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="latRpyDate" lay-verify="required" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="closeDate" >
									</div>
								</div>
							</div>			
						</div>
				...
				<!-- 大额专项分期信息段 start-->
				<div class="layui-colla-item" style="display:none;" data-value="I">
					<form class="layui-form">
						<input type="button" id="stagingAddBtn" style="display:none;" value="新增"
							   class="layui-btn layui-btn-xs pane-title-btn"></input>
						<input type="button" lay-filter="stagingSaveBtn" lay-submit id="stagingSaveBtn" style="display:none;"
    						   class="layui-btn layui-btn-xs pane-title-btn" value="保存当前段"></input>
						<input type="button" id="stagingDelBtn" value="删除" style="display:none;margin-right:110px;"
							   class="layui-btn layui-btn-xs pane-title-btn" ></input>
						<h3 class="layui-colla-title">大额专项分期信息段</h3>
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="specLine" lay-verify="required|regCapValue">
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="specEfctDate" lay-verify="required" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="specEndDate" lay-verify="required" >
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input" id="usedInstAmt" lay-verify="required|regCapValue">
									</div>
								</div>
							</div>
						</div>
...
<script src="static/js/pecr/indv/indvLoanChangeEditR2.js" charset="utf-8"></script>
