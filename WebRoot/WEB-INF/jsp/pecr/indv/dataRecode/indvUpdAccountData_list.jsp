...
<div class="wrap">
	<div class="layui-tab layui-tab-brief" lay-filter="loanAcctInfotab" style="height: 100%;">
		<ul class="layui-tab-title">
			<li data-type="212" class="layui-this">个人借贷协议按段更正请求记录</li>
			<li data-type="222">个人授信协议按段更正请求记录</li>
			<li data-type="232">个人担保账户按段更正请求记录</li>
		</ul>
			<div class="layui-tab-content" style="position: absolute;left: 0;right: 0;top: 35px;bottom: 0;">
			<div data-type="212" class="layui-tab-item layui-show" style="width: 100%;height: 100%;">
				<iframe src="" data-src="upDaccountData/indvProtocolChangeEdit.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="222" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfo/indvLoanAcctInfoEditR1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="232" class="layui-tab-item" style="width: 100%;height: 100%;">
...
<script src="static/js/pecr/indv/indvUpdAccount.js" charset="utf-8"></script>
</body>
</html>
