		...
		<div class="layui-colla-item">
			...
			<div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
				<div class="layui-form-item">
					...
					<div class="layui-inline">
					<label class="layui-form-label">债务人证件号码</label>
					<div class="layui-input-inline">
...
//展示已知数据
  table.render({
	...
	,url:'auditing/dataGuarAcctInfo.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
		,{field: 'name', align:'center', title: '债务人姓名'}
        ,{field: 'idType', align:'center', title: '债务人身份标识类别', templet:function(d){return renderColumnDict(d,'idType',staticDict.idType)}}
		,{field: 'idNum', align:'center', title: '债务人身份标识号码'}
		...
		var layEvent = obj.event;
		 if (layEvent === 'more'){
			...
			layer.open({
				...
				anim: 2,
				resize: false,
				content: 'indvGuarAcctInfo/guarAcctInfoEdit.do?addOrUpdate=' + addOrUpdate
				  	...
				  	layer.open({
						...
						yes: function (index,layero){
							...
							$.ajax({ 
								...
								data     : {state:'30',strIds:strIds,auditOpinion:auditOpinion,tableName:'I_GUAR_ACCT_BS',tablePk:'PDA_GUAR_ACCT_BS_SGMT_ID'},
								type     : 'post',  
								cache    : false,  
								dataType : 'json',  
					  	...
					  	btn2: function (index,layero){
							...
							$.ajax({ 
								url      : 'auditing/isAuditing.do', 
								data     : {state:'40',strIds:strIds,auditOpinion:auditOpinion,tableName:'I_GUAR_ACCT_BS',tablePk:'PDA_GUAR_ACCT_BS_SGMT_ID'},
								type     : 'post',  
								cache    : false,  
								dataType : 'json',  
								success:function(result){ 
