		  ...
		  <div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
				<div class="layui-inline">
	                ...
	                <div class="layui-input-inline">
	                    <input type="text" name="name" id="name" autocomplete="off" class="layui-input" style="width: 188px;"/>
	                </div>
	            </div>
	            <!-- <div class="layui-inline">
	                <label class="layui-form-label">证件类型</label>
	                <div class="layui-input-inline">
	                    <select lay-search="" readonly name="idType" id="idType">
	            ...
	            <div class="layui-inline">
	                ...
	                <div class="layui-input-inline">
	                    <input type="text" name="idNum" id= "idNum" autocomplete="off" class="layui-input" style="width: 188px;" />
	                </div>
	            </div>
	            <div class="layui-inline">
	                <label class="layui-form-label">授信协议标识码:</label>
	                <div class="layui-input-inline">
	                   <input type="text" name="contractCode" id= "contractCode" autocomplete="off" class="layui-input" style="width: 188px;" />
	                </div>
	            </div>
	            <div class="layui-inline">
	                <label class="layui-form-label">待更正段段标:</label>
	                <div class="layui-input-inline" style="width: 188px;">
	                   <select lay-filter="mdfcSgmtCode" id="mdfcSgmtCode" name="mdfcSgmtCode" lay-verify="required" >
	                        <option value=""></option>
	                    </select>
	                </div>
	            </div>
	            <div class="layui-inline">
	                <label class="layui-form-label">信用报告月份</label>
	                <div class="layui-input-inline">
						<input type="text" name="rptDate" id= "rptDate" autocomplete="off" class="layui-input datefield" style="width: 188px;" />
	                </div>
	            </div>
			</div>
		  </div>						  
...
<script src="static/js/pecr/indv/indvProtocolSearch.js" charset="utf-8"></script>
