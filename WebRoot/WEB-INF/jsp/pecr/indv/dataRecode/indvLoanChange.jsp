...
<div class="layui-col-md12" style="display:none;margin:30px auto;text-align: center" id="uploadPage">
	<form class="layui-form layui-form-pane" lay-filter="exampleForm" id="exampleForm" enctype="multipart/form-data">	
		<div class="layui-form-item" id="saveAddBtn">
			...
			<div class="layui-inline">
			  <div class="layui-upload">
				<button class="layui-btn layui-btn-xs" id="downloadTemplateFile" >下载模板<i class="layui-icon layui-icon-download-circle"></i></button>
			  </div>
			</div>
		</div>
...
<script src="static/js/pecr/indv/indvLoanChange.js" charset="utf-8"></script>
