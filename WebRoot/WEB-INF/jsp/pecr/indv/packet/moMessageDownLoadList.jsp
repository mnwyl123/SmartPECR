...
//展示已知数据  
  table.render({
	...
	,url:'indvMessageDownLoad/dataList.do?type=mo' //url
    ,cols: [[ 
      ...
      ,{field: 'REPORT_MESSAGE_TYPE', align:'center' , title: '报送报文类型',templet: function(d){return renderColumnDict(d, 'REPORT_MESSAGE_TYPE', staticDict.moInFrecType)}}
...
//      ,{field: 'create_success_time', align:'center', title: '创建完成时间'}
  ...
  table.on('toolbar(tableDemo)', function(obj){
	  ...
	  }else if(obj.event === 'showFeedback') {
		  //获取选中的行信息
		 var checkStatus = table.checkStatus('tableDemo');
		 //获取选中行的数据
		 data=checkStatus.data;
