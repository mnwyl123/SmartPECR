...
<script type="text/html" id="toolbarHead">
	...
	<button class="layui-btn layui-btn-xs layui-btn-radius"  lay-event="showFeedback"  id="showFeedback">反馈详情下载 <i class="layui-icon layui-icon-download-circle"></i></button>
				...
				$.ajax({  
					...
					success:function(data){
						for(var i=0;i<data.result.length;i++){
							//注释掉以下代码，已从staticDict.js中加载字典。数据库中对应记录为空，会导致再次赋值，将下拉置为空
...
//展示已知数据  
  table.render({
	...
	,url:'indvMessageDownLoad/dataList.do?type=indv' //url
    ,cols: [[ 
      ...
      ,{field: 'report_message_type', align:'center' , title: '报送报文类型',templet: function(d){return renderColumnDict(d, 'report_message_type', staticDict.reportMessageType)}}
