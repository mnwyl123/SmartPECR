								...
								<div id="jzts" style="display: block; width: 100%; position: fixed; z-index: 99999999;">
									...
									<table style="width:95%;" >
										<tr>
											...
											<input type="file" id="files" multiple="multiple" name="excel" style="width:240px;height:25px;" onchange="fileType(this)" />
											</div>
											<a id="tishi" class="tishi" style="display:none; font-size:15px;color:red">
											请选择enc格式的文件
											</a>
											</td>
										</tr>
