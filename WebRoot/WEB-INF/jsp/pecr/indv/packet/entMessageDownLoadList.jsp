...
initDict('infRecType', enterDict.reportMessageType);
//弹出层id
var popIndex;
 ...
 layui.use(['form', 'laydate', 'element', 'layer', 'table', 'laypage','laytpl'], function(){
		...
		require(['static/js/pecr/module/base'],function(base){
		    ...
		    var initEnumerationValue = function(){
				var array = ['ENTDV_INFRECTYPE','REPORT_STATUS'];
				var selectData = [];
				...
				$.ajax({  
					...
					success:function(data){
						for(var i=0;i<data.result.length;i++){
							 if (data.result[i].ENTDV_INFRECTYPE){
								base.renderTpl({
									tplId : "enumerationValueTpl",
									arr : {"list" : data.result[i].ENTDV_INFRECTYPE},
...
//展示已知数据  
  table.render({
	...
	,url:'indvMessageDownLoad/dataList.do?type=ent' //url
    ,cols: [[ 
      ...
      ,{field: 'REPORT_MESSAGE_TYPE', align:'center' , title: '报送报文类型',templet: function(d){return renderColumnDict(d, 'REPORT_MESSAGE_TYPE', enterDict.reportMessageType)}}
