...
<script type="text/html" id="toolbarHead">
	...
	<button class="layui-btn layui-btn-xs layui-btn-radius"  lay-event="showFeedback" lay-event="showFeedback"  id="showFeedback">反馈详情下载 <i class="layui-icon layui-icon-download-circle"></i></button>
...
initDict('infRecType', staticDict.INFOTYPE);
...
//展示已知数据  
  table.render({
	...
	,url:'indvMessageDownLoad/dataList.do?type=indvSp' //url
    ,cols: [[ 
      ...
      ,{field: 'REPORT_MESSAGE_TYPE', align:'center' , title: '报送报文类型',templet: function(d){return renderColumnDict(d, 'REPORT_MESSAGE_TYPE', staticDict.INFOTYPE)}}
...
//      ,{field: 'create_success_time', align:'center', title: '创建完成时间'}
      ...
      ,{field: 'CREATE_TIME', align:'center', title: '报送时间'}
