	...
	<form class="layui-form layui-form-pane" lay-filter="exampleForm" id="exampleForm">	
		<div class="layui-form-item" style="margin-left:30px;">
			...
			<div class="layui-inline">
			  <label class="layui-form-label">家族关系</label>
			  <div class="layui-input-inline">
				<input type="text" name="famRel" id="famRel" autocomplete="off" class="layui-input">
			  </div>
			</div>
			<div class="layui-inline">
			  <label class="layui-form-label">家族关系有效标志</label>
			  <div class="layui-input-inline">
				<input type="text" name="famRelaAssFlag" id="famRelaAssFlag" autocomplete="off" class="layui-input">
			  </div>
			</div>
			<div class="layui-inline">
			  <label class="layui-form-label">信息来源编码</label>
...
//      ,{align : "center",field: 'orgName', title: '数据来源机构名称'}
