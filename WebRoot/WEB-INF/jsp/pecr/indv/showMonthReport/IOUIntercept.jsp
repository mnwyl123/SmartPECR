                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" placeholder="" class="layui-input datefield" id="reportDate">
                        </div>
                    </div>
...
//展示已知数据
        table.render({
            ...
            , url: 'indv/dataIntercept/getDataList.do?tabName=IOU_INTERCEPT_DETAIL' //url
            , cols: [[
                {type: 'numbers'}	//列每行序号
                // , {type: 'checkbox'} //列复选框
                ...
                , {align: "center", field: 'lastMonOutstandingIouNum', title: '上月未结清借据数'}
                , {align: "center", field: 'currMonAddIouNum', title: '当月新增借据数'}
                , {align: "center", field: 'currMonInterceptIouNum', title: '当月拦截借据数'}
                , {align: "center", field: 'currMonClosedIouNum', title: '当月报结清借据数'}
                , {align: "center", field: 'currMonNormalRepIouNum', title: '当月正常上报借据数'}
                , {align: "center", field: 'notReportIouNum', title: '未上报借据数'}
