            ...
            <div class="layui-colla-content layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select lay-search="" id="whiteList_Type" name="whiteList_Type">
                                <option value="">请选择</option>
                            </select>
                        </div>
                    </div>
...
//展示已知数据
        table.render({
            ...
            , url: 'indv/dataIntercept/getDataList.do?tabName=IOU_INTERCEPT_STATISTICS' //url
            , cols: [[
                {type: 'numbers'}	//列每行序号
                // , {type: 'checkbox'} //列复选框
                ...
                , {align: "center", field: 'whiteListType', title: '白名单类型'}
                , {align: "center", field: 'currMonInterceptIouNum', title: '当月拦截借据数'}
                , {align: "center", field: 'twoMonInterceptIouNum', title: '连续两个月拦截借据数'}
                , {align: "center", field: 'threeMonInterceptIouNum', title: '连续三个月拦截借据数'}
