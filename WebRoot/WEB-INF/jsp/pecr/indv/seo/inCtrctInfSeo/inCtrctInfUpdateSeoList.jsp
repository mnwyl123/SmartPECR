			...
			<div class="layui-form-item">
				<div class="layui-inline">
				  ...
				  <div class="layui-input-inline">
					<input type="text" name="CONTRACT_CODE" id="CONTRACT_CODE" autocomplete="off"  class="layui-input"/>
				  </div>
				</div>
				<div class="layui-inline">
...
//展示已知数据
  table.render({
	...
	,url:'inCtrctInfSeo/dataListForUpdate.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'CONTRACT_CODE', title: '授信协议标识码'}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'inCtrctInfSeo/listHistPageForUpdate.do?CONTRACT_CODE=' + data.CONTRACT_CODE,
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
