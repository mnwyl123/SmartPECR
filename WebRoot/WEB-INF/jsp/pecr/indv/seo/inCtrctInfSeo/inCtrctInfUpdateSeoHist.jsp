...
//展示已知数据
  table.render({
	...
	,url:'inCtrctInfSeo/dataHistListForUpdate.do?CONTRACT_CODE='+ dataObj.CONTRACT_CODE //url
    ,cols: [[ 
    	{type:'numbers'},	//列每行序号
		{type:'checkbox'}, //列复选框
...
//		{field: 'mngmtOrgCode', align:'center', title: '所属机构'},
		...
		{field: 'mdfcSgmtCode', align:'center', title: '更正段段标',templet:function(d){return renderColumnDict(d,'mdfcSgmtCode',staticDict.perCreditUpdInfRecType)}},
			...
			layer.open({
  			...
  			layer.open({
  				...
  				content: 'inCtrctInfSeo/indvBasicsInfoDetail.do?addOrUpdate=' + addOrUpdate
  				         + '&pcaCtrctBsSgmtId=' + data.pcaCtrctBsSgmtId
  				         + "&queryType=indvCtrctUpdateBySegment",
  				end: function(){
  					tableReload(); 
  				}
  			});
