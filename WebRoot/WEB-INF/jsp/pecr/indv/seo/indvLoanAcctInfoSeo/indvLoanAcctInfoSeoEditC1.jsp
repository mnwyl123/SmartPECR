						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="openDate" lay-verify="required" readonly>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
						...
						<div class="layui-colla-content">
							<div class="layui-form-item layui-layer-padding">
								...
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="nomonthLatRpyDate" lay-verify="required" readonly>
									</div>
								</div>
								<div class="layui-inline layui-col-xs2" style="margin-bottom: -10px; margin-left:20px;">
									<label class="layui-form-label" style="float:none;text-align: left;">
									...
									<div class="layui-input-inline" style="width: 100%;">
										<input type="text" placeholder="" class="layui-input datefield" id="nomonthCloseDate" readonly>
									</div>
								</div>
							</div>
						</div>
	...
	<form class="layui-form">
		<div class="layui-form-item layui-col-space20" style="margin: 0;">
			...
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px; margin-left:20px;">
				...
				<div class="layui-input-inline" style="width: 100%;">
					<input type="text" placeholder="" class="layui-input datefield" id="tranDate" name='tranDate' lay-verify="required" readonly>
				</div>
			</div>
			<div class="layui-inline layui-col-xs3" style="margin-bottom: -10px; margin-left:20px;">
				<label class="layui-form-label" style="float:none;text-align: left;">
...
<script src="static/js/pecr/indv/seo/LoanAcctInfo/personLoanInfoEditC1.js" charset="utf-8"></script>
