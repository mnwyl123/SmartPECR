...
//展示已知数据
  table.render({
	...
	,url:'indvLoanAcctInfoSeo/dataHistList.do?ACCT_TYPE=' + dataObj.ACCT_TYPE+"&ACCT_CODE="+dataObj.ACCT_CODE //url
    ,cols: [[ 
    	{type:'numbers'},	//列每行序号
		{type:'checkbox'},  //列复选框
    	...
    	if(flag === 'new'){
			...
			layer.open({
  			...
  			layer.open({
  				...
  				anim: 2,
  				resize: false,
  				content: 'indvLoanAcctInfoSeo/loanAcctInfoEdit.do?addOrUpdate=' + addOrUpdate+ "&pbaAcctBsSgmtId=" + data.pbaAcctBsSgmtId,
  				end: function(){
  					tableReload(); 
  				}
  			});
