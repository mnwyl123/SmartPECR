	...
	<div class="layui-tab layui-tab-brief" lay-filter="loanAcctInfotab" style="height: 100%;">
		...
		<div class="layui-tab-content" style="position: absolute;left: 0;right: 0;top: 35px;bottom: 0;">
			<div data-type="D1" class="layui-tab-item layui-show" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfoSeo/indvLoanAcctInfoEditD1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="R1" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfoSeo/indvLoanAcctInfoEditR1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="R2" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfoSeo/indvLoanAcctInfoEditR2.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="R3" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfoSeo/indvLoanAcctInfoEditR3.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="R4" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfoSeo/indvLoanAcctInfoEditR4.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
			<div data-type="C1" class="layui-tab-item" style="width: 100%;height: 100%;">
				<iframe src="" data-src="indvLoanAcctInfoSeo/indvLoanAcctInfoEditC1.do" frameborder='0' width='100%' height='100%'></iframe>
			</div>
		</div>
	</div>
</div>
...
<script src="static/js/pecr/indv/seo/LoanAcctInfo/personLoanInfoEdit.js" charset="utf-8"></script>
</body>
</html>
