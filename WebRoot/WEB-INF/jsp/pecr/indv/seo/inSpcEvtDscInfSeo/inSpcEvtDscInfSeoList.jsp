			...
			<div class="layui-form-item">
				<div class="layui-inline">
					  ...
					  <div class="layui-input-inline">
						<select  lay-search="" id="ACCT_TYPE" name="ACCT_TYPE">
...
//展示已知数据
  table.render({
	...
	,url:'inSpcEvtDscInfSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'ACCT_TYPE', title: '账户类型', title: '账户类型', templet:function(d){return renderColumnDict(d,'ACCT_TYPE',staticDict.acctType)}}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'inSpcEvtDscInfSeo/listHistPage.do?ACCT_TYPE=' + data.ACCT_TYPE+"&ACCT_CODE="+data.ACCT_CODE,
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
