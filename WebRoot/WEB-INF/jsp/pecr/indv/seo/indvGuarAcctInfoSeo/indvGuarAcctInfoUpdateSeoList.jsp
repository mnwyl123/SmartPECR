...
//展示已知数据
  table.render({
	...
	,url:'indvGuarAcctInfoSeo/dataListForUpdate.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'indvGuarAcctInfoSeo/listHistPageForUpdate.do?ACCT_TYPE=' + data.ACCT_TYPE+"&ACCT_CODE="+data.ACCT_CODE,
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
