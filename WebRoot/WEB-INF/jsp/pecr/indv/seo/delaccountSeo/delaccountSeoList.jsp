...
//展示已知数据
  table.render({
	...
	,url:'delaccountSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'ID_TYPE', title: '证件类型', templet:function(d){return renderColumnDict(d, 'ID_TYPE', staticDict.idType)}}
      ,{align : "center",field: 'ID_NUM', title: '证件号码'}
      ,{align : "center",field: 'DEL_REC_CODE', title: '账户标识码'}
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'delaccountSeo/listHistPage.do',
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
