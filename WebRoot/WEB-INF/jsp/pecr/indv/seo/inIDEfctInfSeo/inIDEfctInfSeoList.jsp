...
//展示已知数据
  table.render({
	...
	,url:'inIDEfctInfSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'NAME', title: '客户名称'}
      ,{align : "center",field: 'ID_TYPE', title: '证件类型',templet: function(d){return renderColumnDict(d, 'ID_TYPE', staticDict.idType)}} //列上要显示字典描述，renderColumnDict中第2个参数为当前列的field值，第3个参数为具体哪个字典变量
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'inIDEfctInfSeo/listHistPage.do?ID_TYPE=' + data.ID_TYPE+ "&ID_NUM=" + data.ID_NUM,
		end: function(){
			table.reload('tableDemo', {
				method : 'post',
				where: {
