		  ...
		  <div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
			<div class="layui-form-item">
				...
				<div class="layui-inline">
				  ...
				  <div class="layui-input-inline">
					<input type="text" name="DEL_REC_CODE" id="DEL_REC_CODE"  class="layui-input">
				  </div>
				</div>
			</div>
		  </div>						  
...
//展示已知数据
  table.render({
	...
	,url:'moDelSeo/dataHistList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
  ...
  table.on('tool(tableDemo)', function(obj){
	  form.val('exampleForm', {'efzMocId':'','lastUpdateTime':'', 'delRecCode':''});
    var data = obj.data;
    	...
    	if(flag1 === 'new' && businessStates == '50'){
    		layer.confirm('是否确认回退报文(该数据所在报文的全部数据状态为审核成功)？', function(index){
	  	   	     $.ajax({
	  	   	       ...
	  	   	       type : "POST",
	  	   	       //请求地址
	  	   	       url : "moDelSeo/backdate.do?addOrUpdate="+addOrUpdate,
	  	   	       //数据，json字符串
	  	   	       data : data,
	  	   	       //请求成功
	  	   	       success : function(result) {
