			...
			<div class="layui-form-item">
				<div class="layui-inline">
					  ...
					  <div class="layui-input-inline">
						<select  lay-search="" id="CERT_TYPE" name="CERT_TYPE">
				...
				<div class="layui-inline">
				  ...
				  <div class="layui-input-inline">
					<input type="text" name="CERT_NUM" id="CERT_NUM" autocomplete="off"  class="layui-input"/>
				  </div>
				</div>
			</div>
		  </div>						  
...
//展示已知数据
  table.render({
	...
	,url:'moDelSeo/dataList.do' //url
    ,cols: [[ 
      {type:'numbers'}	//列每行序号
      ,{type:'checkbox'} //列复选框
      ,{align : "center",field: 'CERT_TYPE', title: '账户类型', title: '账户类型'}
      ,{align : "center",field: 'CERT_NUM', title: '账户标识码'}
  ...
  $("#queryBtn").on('click', function(){
	  table.reload('tableDemo',{
		  method : 'post',
			where: {
				ACCT_TYPE   :   $('#CERT_TYPE').val(), 
				ACCT_CODE      :   $('#CERT_NUM').val()
				}
	  }); 
	  return false;
  });
  ...
  table.on('tool(tableDemo)', function(obj){
    ...
    layer.open({
		...
		anim: 2,
		resize: false,
		content: 'moDelSeo/listHistPage.do?CERT_TYPE=' + data.CERT_TYPE+"&CERT_NUM="+data.CERT_NUM,
		end: function(){
