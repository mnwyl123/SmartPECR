...
<div class="wrap">
	<div class="layui-form layui-form-pane" id="queryPanel">
		<div class="layui-colla-item">
			...
			<div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
				...
				<!-- 	<div class="layui-inline">
					...
					<div class="layui-inline">
					  <label class="layui-form-label">债务人身份类别</label>
					  <div class="layui-input-inline">
						<select  lay-search="" lay-filter="infoIdType" id="infoIdType" name="infoIdType">
						  <option value="">请选择</option>										 
						</select>								
					  </div>
					</div>
	 ...
	 <!-- 数据渲染 -->
	<table class="layui-hide" id="motgaTab" lay-filter="motgaTab"></table>
</div> 
...
<script src="static/js/pecr/mortgage/motgaContractInfoList.js" charset="utf-8"></script>
</body>
</html>
