			...
			<div class="layui-colla-content layui-show" style="margin:1px 1px 0px 0px">
				<div class="layui-form-item">
					<div class="layui-inline">
					  <label class="layui-form-label">债务人名称</label>
					  <div class="layui-input-inline">
						<input type="text" name="name" id="name" autocomplete="off" class="layui-input"/>								
					  </div>
					</div>
					<div class="layui-inline">
					  <label class="layui-form-label" style="width: 130px;">债务人身份标识类型</label>
					  <div class="layui-input-inline">
						<select  lay-search="" id="certType" name="certType">
						  <option value="">请选择</option>										 
						</select>								
					  </div>
					</div>
					<div class="layui-inline">
						<label class="layui-form-label" style="width: 130px;">债务人身份标识号码</label>
						<div class="layui-input-inline">
							<input type="text" placeholder="" class="layui-input" name="certNum" id="certNum">
						</div>
					</div>
				</div>
			</div>
...
//展示已知数据
  table.render({
	...
	,url:'auditing/dataMotgaCltalBsPage.do' //url
    ,cols: [[
			{type:'numbers'},	//列每行序号
			{type:'checkbox'},  //列复选框
		...
		switch (obj.event) {
			case 'auditingBtn':
				 ...
				 for(var i = 0; i < data.length; i++){
					 strIds+=checkStatus.data[i].efaMotgaCltalCtrctBsId+",";
				}
				  	...
				  	layer.open({
						...
						yes: function (index,layero){
							...
							$.ajax({ 
								...
								data     : {state:'30',strIds:strIds,auditOpinion:auditOpinion,tableName:'MOTGA_CLTAL_CTRCT_BS',tablePk:'EFA_MOTGA_CLTAL_CTRCT_BS_ID'},
								type     : 'post',  
								cache    : false,  
								dataType : 'json',  
					  	...
					  	btn2: function (index,layero){
							...
							$.ajax({ 
								url      : 'auditing/isAuditing.do', 
								data     : {state:'40',strIds:strIds,auditOpinion:auditOpinion,tableName:'MOTGA_CLTAL_CTRCT_BS',tablePk:'EFA_MOTGA_CLTAL_CTRCT_BS_ID'},
								type     : 'post',  
								cache    : false,  
								dataType : 'json',  
								success:function(result){ 
