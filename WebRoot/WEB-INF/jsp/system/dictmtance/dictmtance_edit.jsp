					...
					<form action="dictmtance/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped" >
							<tr>
								...
								<td class="paddingt-13"><input type="text" name="DIC_CODE" id="DIC_CODE" value="${pd.DIC_CODE}" maxlength="50" placeholder="这里输入字典编码" title="字典编码" class="width-75" onblur="hasD();" <c:if test="${null != pd.DIC_CODE}">readonly="readonly" disabled</c:if>/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="DIC_VAL_COLNAME" id="DIC_VAL_COLNAME" value="${pd.DIC_VAL_COLNAME}" maxlength="50" placeholder="这里输入字典列对应的取值列" title="字典列对应的取值列" class="width-75"/></td>
							</tr>
							<tr>
								<td class="align-right">取值名称:<span class="red ">*</span></td>
								<td><input type="text" name="DIC_DES_COLNAME" id="DIC_DES_COLNAME" value="${pd.DIC_DES_COLNAME}" maxlength="50" placeholder="这里输入字典列对应的描述列" title="字典列对应的描述列" class="width-75"/></td>
							</tr>
							<!-- 
							<tr>
