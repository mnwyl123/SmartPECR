								...
								<table class="margin-5 width-100">
									<tr>
										<td class="text-left jianju" style="margin-left:10px;">
											...
											<div class="btn-group jianju2" >
											<a class="btn btn-mini" onclick="pushCacheAll('确定要刷新字典缓存吗?');" title="缓存字典刷新" ><i class="iconfont icon-iconfontshuaxin"></i></a>
											</div>
											</c:if>
										</td>
									</tr>
									...
									<table id="simple-table" class="table table-striped table-bordered table-hover" style="table-layout:fixed">	
										<thead>
											<tr>
												...
												<th class="center" width="100px">编码</th>
												<th class="center" width="150px">名称</th>
												<!--  <th class="center">类型</th>-->
												<th class="center" width="180px">来源表</th>
												<th class="center" width="150px">过滤条件列</th>
												<!-- <th class="center" width="350px">过滤条件列取值</th> -->
												<th class="center" width="150px">取值列</th>
												<th class="center" width="150px">取值名称</th>
