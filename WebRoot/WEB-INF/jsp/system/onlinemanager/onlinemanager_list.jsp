                        ...
                        <table class="margin-5 width-100">
                            <tr class="width-100">
                                <td class="align-left width-10">
                                    ...
                                    <div class="float-l" id="onlineCount">0</div>
                                </td>
                            </tr>
                        </table>
                        <div class="tab">
                                    ...
                                    <td class="text-left jianju" style="margin-left:10px;">
                                        <c:if test="${QX.batchDelete == 1 }">
                                            <div class="btn-group  jianju">
                                                <a class="btn btn-mini" title="批量强制下线"
                                                   onclick="makeAll('确定要把这些用户强制下线吗?');"><i style="font-size: 18px;"
                                                                                           class="iconfont icon-xiaxiantubiao"></i></a>
                                            </div>
                                        </c:if>
                                    </td>
                                </tr>
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    <th class="center width35">
                                        <label><input class="ace" type="checkbox" id="zcheckbox"/><span
