				...
				<div class="row">
					...
					<form action="org/${msg }.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="PARENT_ID" id="PARENT_ID" value="${pd.PARENT_ID}"/>
							...
							<tr>
								<td class="align-right">机构编码:<span class="red ">*</span></td>
							...
							<tr>
								<td class="align-right">机构对应的总行区段码:<span class="red ">*</span></td>
								<td><input type="text" name="ORG_CODE_FOURTEEN" id="ORG_CODE_FOURTEEN" value="${pd.ORG_CODE_FOURTEEN}" maxlength="32" placeholder="这里输入机构对应的总行区段码，长度14位的" title="机构对应的总行区段码" class="width-85"/></td>
							</tr>
							<tr>
								<td class="align-right">本机构对应区段码:<span class="red ">*</span></td>
								<td><input type="text" name="EACH_ORG_CODE_FOURTEEN" id="EACH_ORG_CODE_FOURTEEN" value="${pd.EACH_ORG_CODE_FOURTEEN}" maxlength="32" placeholder="这里输入本机构对应区段码，为14位的" title="本机构对应区段码" class="width-85"/></td>
							</tr>
							<tr>
