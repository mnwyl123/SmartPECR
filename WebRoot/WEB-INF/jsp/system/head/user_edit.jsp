					...
					<div class="row">
						<div class="col-xs-12" style="padding:0;">
								<form action="head/${msg }.do" name="userForm" id="userForm" method="post">
									...
									<div id="zhongxin" style="padding-top: 13px;width:90%;padding-left:10%;">
									<table id="table_report" class="table table-striped">
										<tr>
											<td style="width:85px;text-align: right;padding-top: 13px;">登录编码:<span class="red ">*</span></td>
										...
										<tr>
											<td style="width:85px;text-align: right;padding-top: 13px;">密码:<span class="red ">*</span></td>
											<td><input type="password" name="PASSWORD" id="password"  maxlength="32" placeholder="输入密码" title="密码" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:85px;text-align: right;padding-top: 13px;">确认密码:<span class="red ">*</span></td>
											<td><input type="password" name="chkpwd" id="chkpwd"  maxlength="32" placeholder="确认密码" title="确认密码" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:85px;text-align: right;padding-top: 13px;">用户姓名:<span class="red ">*</span></td>
										...
										<tr>
											<td style="width:85px;text-align: right;padding-top: 13px;">手机号:<span class="red ">*</span></td>
											<td><input type="number" name="PHONE" id="PHONE"  value="${pd.PHONE }"  maxlength="32" placeholder="这里输入手机号" title="手机号" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:85px;text-align: right;padding-top: 13px;">邮箱:<span class="red ">*</span></td>
