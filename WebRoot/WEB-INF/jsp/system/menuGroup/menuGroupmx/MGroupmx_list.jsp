...
<body class="no-skin" onkeydown="KeyDown()">
							...
							<tr>
								<td class="align-left width-50 searchM" >
									<div class="btn-group" style="margin-left:-25px;">
										<a class="btn btn-mini" onclick="toExcel('${pd.FUN_GROUP_ID }');" title="导出到EXCEL" style="line-height:30px;margin-left: 35px;"><i style="font-size:18px;" class="iconfont icon-xiazai"></i></a>
									</div>
									<div class="btn-group jianju2">
										<a class="btn btn-mini" onclick="add();">
											<i class="iconfont icon-tianjia"></i>
										</a>
									</div>
									<div class="btn-group jianju2" >
										<a title="批量删除" class="btn btn-mini" onclick="makeAll('确定要删除选中的数据吗?','${pd.FUN_GROUP_ID }');" >
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>menuGroupmx/excel.do?&IDS='+str;
		}
	</script>
