...
<body class="no-skin" onkeydown="KeyDown()">
								...
								<table id="simple-table" class="table table-striped table-bordered table-hover">	
									<thead>
										<tr>
											...
											<th class="center">功能组ID</th>
											<th class="center">功能组名称</th>
											<th class="center">功能组英文名称</th>
											<th class="center">功能组描述</th>
	...
	<script type="text/javascript">
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>menuGroup/excel.do?IDS='+str;
			}
		}
