...
<c:if test="${msg == 'edit' }">
	<div id="zhongxin1">
		<iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/menuGroupmx/list.do?FUN_GROUP_ID=${pd.FUN_GROUP_ID}" style="margin:0 auto;width:100%;height:420px;;"></iframe>
	</div>
</c:if>
