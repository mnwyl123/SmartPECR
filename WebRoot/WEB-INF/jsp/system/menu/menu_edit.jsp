					...
					<form  action="menu/${MSG }.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
						...
						<input type="hidden" name="PARENT_ID" id="PARENT_ID" value="${pd.PARENT_ID}"/>
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control width-85" dict-name="sysApps" default-value="${pd.SYS_IND}" name="SYS_IND" id="SYS_IND">
										<option value="">请选择</option>
										</select>
								<!--
									<select name="SYS_IND" id="SYS_IND"  class="width-85">
